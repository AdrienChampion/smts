...
(assert (not (= def use)))
(assert (let ((?v_2 0.0) (?v_1 (select (select q tptp_sum_index) pv35)) (?v_3 (select x tptp_sum_index)) (?v_0 (- 135300 1))) (let ((?v_4 (- ?v_3 (select (store mu pv35 (divide pv80 pv44)) pv35)))) (not (=> (and (and (and (= pv78 (sum 0 ?v_0 ?v_1)) (= pv80 (sum 0 ?v_0 (* ?v_1 ?v_3)))) (>= pv35 0)) (<= pv35 (- 5 1))) (=> (not (= ?v_2 pv44)) (= ?v_2 (sum 0 (- 0 1) (* ?v_4 (* ?v_4 ?v_1))))))))))
(check-sat)
(exit)
