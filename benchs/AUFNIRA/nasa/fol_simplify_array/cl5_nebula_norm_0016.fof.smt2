...
(assert (not (= def use)))
(assert (let ((?v_2 (select x pv10)) (?v_1 (select sigma tptp_sum_index)) (?v_4 (select sigma pv45)) (?v_5 (sqrt (* 2.0 tptp_pi)))) (let ((?v_0 (- ?v_2 (select mu tptp_sum_index)))) (let ((?v_6 (divide (* (exp (divide (divide (* ?v_0 ?v_0) tptp_minus_2) (* ?v_1 ?v_1))) (select rho tptp_sum_index)) (* ?v_5 ?v_1))) (?v_3 (- ?v_2 (select mu pv45)))) (not (=> (and (and (and (and (and (and (and (and (= pv84 (sum 0 (- pv45 1) ?v_6)) (>= pv10 0)) (>= pv45 0)) (>= pv47 0)) (<= pv10 135299)) (<= pv45 4)) (<= pv47 4)) (forall ((?A_59 Int)) (let ((?v_8 (select sigma ?A_59)) (?v_7 (- ?v_2 (select mu ?A_59)))) (=> (and (>= ?A_59 0) (<= ?A_59 (- pv47 1))) (= (select (select q pv10) ?A_59) (divide (divide (* (exp (divide (divide (* ?v_7 ?v_7) tptp_minus_2) (* ?v_8 ?v_8))) (select rho ?A_59)) (* ?v_5 ?v_8)) (sum 0 4 ?v_6))))))) (forall ((?B_60 Int)) (=> (and (>= ?B_60 0) (<= ?B_60 (- pv10 1))) (= (sum 0 4 (select (select q ?B_60) tptp_sum_index)) 1.0)))) (= (+ pv84 (divide (* (exp (divide (divide (* ?v_3 ?v_3) tptp_minus_2) (* ?v_4 ?v_4))) (select rho pv45)) (* ?v_5 ?v_4))) (sum 0 pv45 ?v_6))))))))
(check-sat)
(exit)
