...
(assert (not (= def use)))
(assert (let ((?v_1 (select (select q tptp_sum_index) pv35)) (?v_2 (select mu pv35))) (let ((?v_0 (- (select x tptp_sum_index) ?v_2))) (let ((?v_4 (* ?v_0 (* ?v_0 ?v_1))) (?v_3 (- (select x pv41) ?v_2))) (not (=> (and (and (and (and (and (= pv78 (sum 0 135299 ?v_1)) (= pv82 (sum 0 (- pv41 1) ?v_4))) (>= pv35 0)) (>= pv41 0)) (<= pv35 4)) (<= pv41 135299)) (= (+ (* ?v_3 (* ?v_3 (select (select q pv41) pv35))) pv82) (sum 0 pv41 ?v_4))))))))
(check-sat)
(exit)
