...
(assert (not (= def use)))
(assert (not (forall ((?A_59 Real) (?L_60 Real)) (=> (and (and (and (and (and (and (and (>= pv5 0) (<= pv5 0)) (<= pv5 588)) (> pv5 0)) (forall ((?B_61 Int) (?C_62 Int)) (=> (and (and (and (>= ?B_61 0) (>= ?C_62 0)) (<= ?B_61 5)) (<= ?C_62 5)) (= (select (select q_thruster_filter ?B_61) ?C_62) (select (select q_thruster_filter ?C_62) ?B_61))))) (forall ((?D_63 Int) (?E_64 Int)) (=> (and (and (and (>= ?D_63 0) (>= ?E_64 0)) (<= ?D_63 3)) (<= ?E_64 3)) (= (select (select r_thruster_filter ?D_63) ?E_64) (select (select r_thruster_filter ?E_64) ?D_63))))) (forall ((?F_65 Int) (?G_66 Int)) (=> (and (and (and (>= ?F_65 0) (>= ?G_66 0)) (<= ?F_65 5)) (<= ?G_66 5)) (= (select (select pminus_thruster_filter ?F_65) ?G_66) (select (select pminus_thruster_filter ?G_66) ?F_65))))) (forall ((?H_67 Int)) (=> (and (>= ?H_67 0) (<= ?H_67 5)) (forall ((?I_68 Int)) (=> (and (>= ?I_68 0) (<= ?I_68 5)) (= (select (select id_thruster_filter ?H_67) ?I_68) (select (select id_thruster_filter ?I_68) ?H_67))))))) (forall ((?J_69 Int) (?K_70 Int)) (let ((?v_0 (select (select xhatmin_thruster_filter 0) 0))) (let ((?v_2 (sin ?v_0)) (?v_3 (cos ?v_0))) (let ((?v_5 (+ (* tptp_float_0_217 ?v_2) (* tptp_float_0_423 ?v_3)))) (let ((?v_1 (store h_thruster_filter 3 (store (select h_thruster_filter 3) 0 (- ?v_5)))) (?v_7 (* tptp_float_0_217 ?v_3)) (?v_8 (* tptp_float_0_423 ?v_2))) (let ((?v_4 (store ?v_1 2 (store (select ?v_1 2) 0 (- ?v_8 ?v_7))))) (let ((?v_6 (store ?v_4 1 (store (select ?v_4 1) 0 ?v_5)))) (let ((?v_12 (store ?v_6 0 (store (select ?v_6 0) 0 (- ?v_7 ?v_8))))) (let ((?v_13 (trans ?v_12)) (?v_9 (store r_thruster_filter 3 (store (select r_thruster_filter 3) 3 (select (select rho 3) pv5))))) (let ((?v_10 (store ?v_9 2 (store (select ?v_9 2) 2 (select (select rho 2) pv5))))) (let ((?v_11 (store ?v_10 1 (store (select ?v_10 1) 1 (select (select rho 1) pv5))))) (let ((?v_14 (store ?v_11 0 (store (select ?v_11 0) 0 (select (select rho 0) pv5))))) (let ((?v_15 (tptp_mmul pminus_thruster_filter (tptp_mmul ?v_13 (inv (tptp_madd ?v_14 (tptp_mmul ?v_12 (tptp_mmul pminus_thruster_filter ?v_13)))))))) (let ((?v_16 (tptp_msub id_thruster_filter (tptp_mmul ?v_15 ?v_12)))) (let ((?v_17 (tptp_madd q_thruster_filter (tptp_mmul phi_thruster_filter (tptp_mmul (tptp_madd (tptp_mmul ?v_15 (tptp_mmul ?v_14 (trans ?v_15))) (tptp_mmul ?v_16 (tptp_mmul pminus_thruster_filter (trans ?v_16)))) (trans phi_thruster_filter)))))) (=> (and (and (and (>= ?J_69 0) (>= ?K_70 0)) (<= ?J_69 5)) (<= ?K_70 5)) (= (select (select ?v_17 ?J_69) ?K_70) (select (select ?v_17 ?K_70) ?J_69))))))))))))))))))))))
(check-sat)
(exit)
