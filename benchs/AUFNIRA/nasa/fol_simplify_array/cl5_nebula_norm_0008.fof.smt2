...
(assert (not (= def use)))
(assert (let ((?v_1 (select x pv10))) (let ((?v_0 (- (select (select center tptp_sum_index) 0) ?v_1))) (let ((?v_3 (sqrt (* ?v_0 ?v_0))) (?v_2 (- (select (select center pv60) 0) ?v_1))) (not (=> (and (and (and (and (and (and (and (and (= pv70 (sum 0 (- pv60 1) ?v_3)) (>= pv10 0)) (>= pv12 0)) (>= pv60 0)) (<= pv10 135299)) (<= pv12 4)) (<= pv60 4)) (forall ((?A_59 Int)) (let ((?v_4 (- (select (select center ?A_59) 0) ?v_1))) (=> (and (>= ?A_59 0) (<= ?A_59 (- pv12 1))) (= (select (select q pv10) ?A_59) (divide (sqrt (* ?v_4 ?v_4)) (sum 0 4 ?v_3))))))) (forall ((?B_60 Int)) (=> (and (>= ?B_60 0) (<= ?B_60 (- pv10 1))) (= (sum 0 4 (select (select q ?B_60) tptp_sum_index)) 1.0)))) (= (+ pv70 (sqrt (* ?v_2 ?v_2))) (sum 0 pv60 ?v_3))))))))
(check-sat)
(exit)
