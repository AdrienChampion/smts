...
(assert (not (= def use)))
(assert (let ((?v_0 (select (select q tptp_sum_index) pv35))) (let ((?v_1 (* ?v_0 (select x tptp_sum_index)))) (not (=> (and (and (and (and (and (= pv78 (sum 0 135299 ?v_0)) (= pv80 (sum 0 (- pv39 1) ?v_1))) (>= pv35 0)) (>= pv39 0)) (<= pv35 4)) (<= pv39 135299)) (= (+ (* (select (select q pv39) pv35) (select x pv39)) pv80) (sum 0 pv39 ?v_1)))))))
(check-sat)
(exit)
