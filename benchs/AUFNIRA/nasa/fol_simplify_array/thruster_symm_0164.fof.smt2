...
(assert (not (= def use)))
(assert (not (forall ((?A_59 Real) (?L_60 Real)) (=> (and (and (and (and (and (and (and (>= pv5 0) (<= pv5 0)) (<= pv5 588)) (> pv5 0)) (forall ((?B_61 Int) (?C_62 Int)) (=> (and (and (and (>= ?B_61 0) (>= ?C_62 0)) (<= ?B_61 5)) (<= ?C_62 5)) (= (select (select q_thruster_filter ?B_61) ?C_62) (select (select q_thruster_filter ?C_62) ?B_61))))) (forall ((?D_63 Int) (?E_64 Int)) (=> (and (and (and (>= ?D_63 0) (>= ?E_64 0)) (<= ?D_63 3)) (<= ?E_64 3)) (= (select (select r_thruster_filter ?D_63) ?E_64) (select (select r_thruster_filter ?E_64) ?D_63))))) (forall ((?F_65 Int) (?G_66 Int)) (=> (and (and (and (>= ?F_65 0) (>= ?G_66 0)) (<= ?F_65 5)) (<= ?G_66 5)) (= (select (select pminus_thruster_filter ?F_65) ?G_66) (select (select pminus_thruster_filter ?G_66) ?F_65))))) (forall ((?H_67 Int)) (=> (and (>= ?H_67 0) (<= ?H_67 5)) (forall ((?I_68 Int)) (=> (and (>= ?I_68 0) (<= ?I_68 5)) (= (select (select id_thruster_filter ?H_67) ?I_68) (select (select id_thruster_filter ?I_68) ?H_67))))))) (forall ((?J_69 Int) (?K_70 Int)) (let ((?v_1 (select (select xhatmin_thruster_filter 0) 0))) (let ((?v_2 (sin ?v_1)) (?v_11 (select (select tr 4) pv5)) (?v_10 (select (select tr 3) pv5)) (?v_0 (cos ?v_1)) (?v_9 (select (select tr 6) pv5)) (?v_8 (select (select tr 5) pv5)) (?v_4 (select (select tr 1) pv5)) (?v_5 (select (select tr 2) pv5)) (?v_6 (select (select tr 0) pv5)) (?v_7 (select (select tr 7) pv5))) (let ((?v_13 (- (- (- (- (+ (* ?v_0 ?v_10) (+ (* ?v_0 ?v_11) (+ (* ?v_2 ?v_4) (* ?v_2 ?v_5)))) (* ?v_0 ?v_6)) (* ?v_0 ?v_7)) (* ?v_2 ?v_8)) (* ?v_2 ?v_9)))) (let ((?v_3 (store phi_thruster_filter 5 (store (select phi_thruster_filter 5) 0 (divide (* tptp_float_0_034 (* tptp_float_1_2 ?v_13)) tptp_float_70_707)))) (?v_15 (- (- (- (- (+ (* ?v_0 ?v_4) (+ (* ?v_0 ?v_5) (+ (* ?v_2 ?v_6) (* ?v_2 ?v_7)))) (* ?v_0 ?v_8)) (* ?v_0 ?v_9)) (* ?v_2 ?v_10)) (* ?v_2 ?v_11)))) (let ((?v_12 (store ?v_3 4 (store (select ?v_3 4) 0 (divide (* tptp_float_0_034 (* tptp_float_1_2 ?v_15)) tptp_float_70_707)))) (?v_19 (+ (* tptp_float_0_217 ?v_2) (* tptp_float_0_423 ?v_0)))) (let ((?v_17 (store h_thruster_filter 3 (store (select h_thruster_filter 3) 0 (- ?v_19)))) (?v_21 (* tptp_float_0_217 ?v_0)) (?v_22 (* tptp_float_0_423 ?v_2))) (let ((?v_18 (store ?v_17 2 (store (select ?v_17 2) 0 (- ?v_22 ?v_21))))) (let ((?v_20 (store ?v_18 1 (store (select ?v_18 1) 0 ?v_19)))) (let ((?v_26 (store ?v_20 0 (store (select ?v_20 0) 0 (- ?v_21 ?v_22))))) (let ((?v_27 (trans ?v_26)) (?v_23 (store r_thruster_filter 3 (store (select r_thruster_filter 3) 3 (select (select rho 3) pv5))))) (let ((?v_24 (store ?v_23 2 (store (select ?v_23 2) 2 (select (select rho 2) pv5))))) (let ((?v_25 (store ?v_24 1 (store (select ?v_24 1) 1 (select (select rho 1) pv5))))) (let ((?v_28 (store ?v_25 0 (store (select ?v_25 0) 0 (select (select rho 0) pv5))))) (let ((?v_29 (tptp_mmul pminus_thruster_filter (tptp_mmul ?v_27 (inv (tptp_madd ?v_28 (tptp_mmul ?v_26 (tptp_mmul pminus_thruster_filter ?v_27)))))))) (let ((?v_30 (tptp_msub id_thruster_filter (tptp_mmul ?v_29 ?v_26))) (?v_16 (divide (* tptp_float_0_034 tptp_float_0_034) 2.0))) (let ((?v_14 (store ?v_12 2 (store (select ?v_12 2) 0 (divide (* tptp_float_1_2 (* ?v_13 ?v_16)) tptp_float_70_707))))) (let ((?v_31 (store ?v_14 1 (store (select ?v_14 1) 0 (divide (* tptp_float_1_2 (* ?v_15 ?v_16)) tptp_float_70_707))))) (let ((?v_32 (tptp_madd q_thruster_filter (tptp_mmul ?v_31 (tptp_mmul (tptp_madd (tptp_mmul ?v_29 (tptp_mmul ?v_28 (trans ?v_29))) (tptp_mmul ?v_30 (tptp_mmul pminus_thruster_filter (trans ?v_30)))) (trans ?v_31)))))) (=> (and (and (and (>= ?J_69 0) (>= ?K_70 0)) (<= ?J_69 5)) (<= ?K_70 5)) (= (select (select ?v_32 ?J_69) ?K_70) (select (select ?v_32 ?K_70) ?J_69))))))))))))))))))))))))))
(check-sat)
(exit)
