...
(assert (not (= def use)))
(assert (not (=> (and (and (and (and (and (and (and (>= pv5 0) (<= pv5 0)) (<= pv5 998)) (> pv5 0)) (forall ((?A_59 Int) (?B_60 Int)) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 5)) (<= ?B_60 5)) (= (select (select q_ds1_filter ?A_59) ?B_60) (select (select q_ds1_filter ?B_60) ?A_59))))) (forall ((?C_61 Int) (?D_62 Int)) (=> (and (and (and (>= ?C_61 0) (>= ?D_62 0)) (<= ?C_61 2)) (<= ?D_62 2)) (= (select (select r_ds1_filter ?C_61) ?D_62) (select (select r_ds1_filter ?D_62) ?C_61))))) (forall ((?E_63 Int) (?F_64 Int)) (=> (and (and (and (>= ?E_63 0) (>= ?F_64 0)) (<= ?E_63 5)) (<= ?F_64 5)) (= (select (select pminus_ds1_filter ?E_63) ?F_64) (select (select pminus_ds1_filter ?F_64) ?E_63))))) (forall ((?G_65 Int)) (=> (and (>= ?G_65 0) (<= ?G_65 5)) (forall ((?H_66 Int)) (=> (and (>= ?H_66 0) (<= ?H_66 5)) (= (select (select id_ds1_filter ?G_65) ?H_66) (select (select id_ds1_filter ?H_66) ?G_65))))))) (forall ((?I_67 Int) (?J_68 Int)) (let ((?v_11 (select (select xhatmin_ds1_filter 5) 0)) (?v_10 (select (select u 2) pv5)) (?v_8 (select (select u 1) pv5)) (?v_7 (select (select xhatmin_ds1_filter 4) 0)) (?v_4 (select (select xhatmin_ds1_filter 3) 0)) (?v_3 (select (select u 0) pv5)) (?v_12 (trans h_ds1_filter))) (let ((?v_13 (tptp_mmul pminus_ds1_filter (tptp_mmul ?v_12 (inv (tptp_madd r_ds1_filter (tptp_mmul h_ds1_filter (tptp_mmul pminus_ds1_filter ?v_12)))))))) (let ((?v_14 (tptp_msub id_ds1_filter (tptp_mmul ?v_13 h_ds1_filter))) (?v_1 (divide 1.0 400.0))) (let ((?v_0 (store phi_ds1_filter 2 (store (select phi_ds1_filter 2) 1 (* ?v_1 (- ?v_4 ?v_3)))))) (let ((?v_2 (store ?v_0 2 (store (select ?v_0 2) 0 (* ?v_1 (- ?v_8 ?v_7)))))) (let ((?v_5 (store ?v_2 1 (store (select ?v_2 1) 2 (* ?v_1 (- ?v_3 ?v_4)))))) (let ((?v_6 (store ?v_5 1 (store (select ?v_5 1) 0 (* ?v_1 (- ?v_11 ?v_10)))))) (let ((?v_9 (store ?v_6 0 (store (select ?v_6 0) 2 (* ?v_1 (- ?v_7 ?v_8)))))) (let ((?v_15 (store ?v_9 0 (store (select ?v_9 0) 1 (* ?v_1 (- ?v_10 ?v_11)))))) (let ((?v_16 (tptp_madd q_ds1_filter (tptp_mmul ?v_15 (tptp_mmul (tptp_madd (tptp_mmul ?v_13 (tptp_mmul r_ds1_filter (trans ?v_13))) (tptp_mmul ?v_14 (tptp_mmul pminus_ds1_filter (trans ?v_14)))) (trans ?v_15)))))) (=> (and (and (and (>= ?I_67 0) (>= ?J_68 0)) (<= ?I_67 5)) (<= ?J_68 5)) (= (select (select ?v_16 ?I_67) ?J_68) (select (select ?v_16 ?J_68) ?I_67)))))))))))))))))
(check-sat)
(exit)
