...
(assert (not (= def use)))
(assert (not (=> true (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_3 (= 5 ?A_59)) (?v_2 (= 5 ?B_60))) (let ((?v_1 (and ?v_3 ?v_2)) (?v_4 (= 4 ?A_59)) (?v_6 (= 3 ?A_59)) (?v_7 (= 2 ?A_59)) (?v_8 (= 1 ?A_59)) (?v_5 (= 4 ?B_60)) (?v_0 (- 6 1))) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 ?v_0)) (<= ?B_60 ?v_0)) (=> ?v_1 (=> (not ?v_1) (=> (not (and ?v_4 ?v_2)) (=> (not (and ?v_6 ?v_2)) (=> (not (and ?v_7 ?v_2)) (=> (not (and ?v_8 ?v_2)) (=> (not (and (= 0 ?A_59) ?v_2)) (=> (not (and ?v_5 ?v_3)) (=> (not (and ?v_4 ?v_5)) (=> (not (and ?v_6 ?v_5)) (=> (not (and ?v_7 ?v_5)) (=> (and ?v_8 ?v_5) (= (* (divide 1.0 400.0) (select sigma 5)) 0.0))))))))))))))))))))
(check-sat)
(exit)
