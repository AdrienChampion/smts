...
(assert (not (= def use)))
(assert (not (=> true (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_1 (= 5 ?A_59)) (?v_2 (= 5 ?B_60))) (let ((?v_11 (not (and ?v_1 ?v_2))) (?v_4 (= 4 ?B_60))) (let ((?v_16 (not (and ?v_4 ?v_1))) (?v_5 (= 3 ?B_60)) (?v_6 (= 2 ?B_60)) (?v_7 (= 1 ?B_60)) (?v_8 (= 0 ?B_60)) (?v_3 (= 4 ?A_59))) (let ((?v_12 (not (and ?v_3 ?v_2))) (?v_17 (and ?v_3 ?v_4)) (?v_9 (= 3 ?A_59))) (let ((?v_13 (not (and ?v_9 ?v_2))) (?v_10 (= 2 ?A_59))) (let ((?v_14 (not (and ?v_10 ?v_2))) (?v_15 (and (= 1 ?A_59) ?v_2)) (?v_0 (- 6 1))) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 ?v_0)) (<= ?B_60 ?v_0)) (=> ?v_11 (=> ?v_16 (=> (not (and ?v_5 ?v_1)) (=> (not (and ?v_6 ?v_1)) (=> (not (and ?v_7 ?v_1)) (=> (not (and ?v_8 ?v_1)) (=> ?v_12 (=> (not ?v_17) (=> (not (and ?v_5 ?v_3)) (=> (not (and ?v_6 ?v_3)) (=> (not (and ?v_7 ?v_3)) (=> (not (and ?v_8 ?v_3)) (=> ?v_13 (=> (not (and ?v_9 ?v_4)) (=> (not (and ?v_9 ?v_5)) (=> (not (and ?v_6 ?v_9)) (=> (not (and ?v_7 ?v_9)) (=> (not (and ?v_8 ?v_9)) (=> ?v_14 (=> (not (and ?v_10 ?v_4)) (=> (not (and ?v_10 ?v_5)) (=> (not (and ?v_10 ?v_6)) (=> (not (and ?v_7 ?v_10)) (=> (not (and ?v_8 ?v_10)) (=> ?v_15 (=> ?v_11 (=> ?v_12 (=> ?v_13 (=> ?v_14 (=> (not ?v_15) (=> (not (and (= 0 ?A_59) ?v_2)) (=> ?v_16 (=> ?v_17 (= 0.0 (* (divide 1.0 400.0) (select sigma 4)))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
