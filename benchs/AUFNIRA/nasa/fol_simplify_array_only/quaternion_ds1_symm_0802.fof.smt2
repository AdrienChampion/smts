...
(assert (not (= def use)))
(assert (not (=> true (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_1 (= 5 ?A_59)) (?v_2 (= 5 ?B_60))) (let ((?v_11 (not (and ?v_1 ?v_2))) (?v_4 (= 4 ?B_60))) (let ((?v_15 (not (and ?v_4 ?v_1))) (?v_5 (= 3 ?B_60))) (let ((?v_21 (not (and ?v_5 ?v_1))) (?v_6 (= 2 ?B_60))) (let ((?v_25 (not (and ?v_6 ?v_1))) (?v_7 (= 1 ?B_60))) (let ((?v_29 (and ?v_7 ?v_1)) (?v_8 (= 0 ?B_60)) (?v_3 (= 4 ?A_59))) (let ((?v_12 (not (and ?v_3 ?v_2))) (?v_16 (not (and ?v_3 ?v_4))) (?v_22 (not (and ?v_5 ?v_3))) (?v_26 (not (and ?v_6 ?v_3))) (?v_9 (= 3 ?A_59))) (let ((?v_13 (not (and ?v_9 ?v_2))) (?v_17 (not (and ?v_9 ?v_4))) (?v_23 (not (and ?v_9 ?v_5))) (?v_27 (not (and ?v_6 ?v_9))) (?v_10 (= 2 ?A_59))) (let ((?v_14 (not (and ?v_10 ?v_2))) (?v_18 (not (and ?v_10 ?v_4))) (?v_24 (not (and ?v_10 ?v_5))) (?v_28 (and ?v_10 ?v_6)) (?v_19 (= 1 ?A_59)) (?v_20 (= 0 ?A_59)) (?v_0 (- 6 1))) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 ?v_0)) (<= ?B_60 ?v_0)) (=> ?v_11 (=> ?v_15 (=> ?v_21 (=> ?v_25 (=> (not ?v_29) (=> (not (and ?v_8 ?v_1)) (=> ?v_12 (=> ?v_16 (=> ?v_22 (=> ?v_26 (=> (not (and ?v_7 ?v_3)) (=> (not (and ?v_8 ?v_3)) (=> ?v_13 (=> ?v_17 (=> ?v_23 (=> ?v_27 (=> (not (and ?v_7 ?v_9)) (=> (not (and ?v_8 ?v_9)) (=> ?v_14 (=> ?v_18 (=> ?v_24 (=> ?v_28 (=> ?v_11 (=> ?v_12 (=> ?v_13 (=> ?v_14 (=> (not (and ?v_19 ?v_2)) (=> (not (and ?v_20 ?v_2)) (=> ?v_15 (=> ?v_16 (=> ?v_17 (=> ?v_18 (=> (not (and ?v_19 ?v_4)) (=> (not (and ?v_20 ?v_4)) (=> ?v_21 (=> ?v_22 (=> ?v_23 (=> ?v_24 (=> (not (and ?v_19 ?v_5)) (=> (not (and ?v_20 ?v_5)) (=> ?v_25 (=> ?v_26 (=> ?v_27 (=> (not ?v_28) (=> (not (and ?v_19 ?v_6)) (=> (not (and ?v_20 ?v_6)) (=> ?v_29 (= (* (divide 1.0 400.0) (select sigma 2)) 0.0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
