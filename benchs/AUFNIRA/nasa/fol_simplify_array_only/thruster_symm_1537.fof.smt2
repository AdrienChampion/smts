...
(assert (not (= def use)))
(assert (not (=> (and (>= (- 4 1) 0) (>= (- 1000 1) 0)) (forall ((?A_59 Real)) (=> (and (<= 0 7) (>= (- 1000 1) 0)) (forall ((?L_60 Real)) (let ((?v_1 (> pv5 0))) (let ((?v_0 (not ?v_1))) (=> (and (and (and (and (and (>= pv5 0) (<= pv5 588)) (forall ((?B_61 Int) (?C_62 Int)) (let ((?v_2 (- 6 1))) (=> (and (and (and (>= ?B_61 0) (>= ?C_62 0)) (<= ?B_61 ?v_2)) (<= ?C_62 ?v_2)) (= (select (select q_thruster_filter ?B_61) ?C_62) (select (select q_thruster_filter ?C_62) ?B_61)))))) (forall ((?D_63 Int) (?E_64 Int)) (let ((?v_3 (- 4 1))) (=> (and (and (and (>= ?D_63 0) (>= ?E_64 0)) (<= ?D_63 ?v_3)) (<= ?E_64 ?v_3)) (= (select (select r_thruster_filter ?D_63) ?E_64) (select (select r_thruster_filter ?E_64) ?D_63)))))) (forall ((?F_65 Int) (?G_66 Int)) (let ((?v_4 (- 6 1))) (=> (and (and (and (>= ?F_65 0) (>= ?G_66 0)) (<= ?F_65 ?v_4)) (<= ?G_66 ?v_4)) (= (select (select pminus_thruster_filter ?F_65) ?G_66) (select (select pminus_thruster_filter ?G_66) ?F_65)))))) (forall ((?H_67 Int)) (=> (and (>= ?H_67 0) (<= ?H_67 (- 6 1))) (forall ((?I_68 Int)) (=> (and (>= ?I_68 0) (<= ?I_68 (- 6 1))) (= (select (select id_thruster_filter ?H_67) ?I_68) (select (select id_thruster_filter ?I_68) ?H_67))))))) (=> ?v_0 (=> ?v_0 (=> ?v_1 (=> ?v_1 (forall ((?J_69 Int) (?K_70 Int)) (let ((?v_5 (- 6 1)) (?v_6 (select (select xhatmin_thruster_filter 0) 0))) (let ((?v_8 (sin ?v_6)) (?v_9 (cos ?v_6))) (let ((?v_11 (+ (* tptp_float_0_217 ?v_8) (* tptp_float_0_423 ?v_9)))) (let ((?v_7 (store h_thruster_filter 3 (store (select h_thruster_filter 3) 0 (- ?v_11)))) (?v_13 (* tptp_float_0_217 ?v_9)) (?v_14 (* tptp_float_0_423 ?v_8))) (let ((?v_10 (store ?v_7 2 (store (select ?v_7 2) 0 (- ?v_14 ?v_13))))) (let ((?v_12 (store ?v_10 1 (store (select ?v_10 1) 0 ?v_11)))) (let ((?v_18 (store ?v_12 0 (store (select ?v_12 0) 0 (- ?v_13 ?v_14))))) (let ((?v_19 (trans ?v_18)) (?v_15 (store r_thruster_filter 3 (store (select r_thruster_filter 3) 3 (select (select rho 3) pv5))))) (let ((?v_16 (store ?v_15 2 (store (select ?v_15 2) 2 (select (select rho 2) pv5))))) (let ((?v_17 (store ?v_16 1 (store (select ?v_16 1) 1 (select (select rho 1) pv5))))) (let ((?v_20 (store ?v_17 0 (store (select ?v_17 0) 0 (select (select rho 0) pv5))))) (let ((?v_21 (tptp_mmul pminus_thruster_filter (tptp_mmul ?v_19 (inv (tptp_madd ?v_20 (tptp_mmul ?v_18 (tptp_mmul pminus_thruster_filter ?v_19)))))))) (let ((?v_22 (tptp_msub id_thruster_filter (tptp_mmul ?v_21 ?v_18)))) (let ((?v_23 (tptp_madd q_thruster_filter (tptp_mmul phi_thruster_filter (tptp_mmul (tptp_madd (tptp_mmul ?v_21 (tptp_mmul ?v_20 (trans ?v_21))) (tptp_mmul ?v_22 (tptp_mmul pminus_thruster_filter (trans ?v_22)))) (trans phi_thruster_filter)))))) (=> (and (and (and (>= ?J_69 0) (>= ?K_70 0)) (<= ?J_69 ?v_5)) (<= ?K_70 ?v_5)) (= (select (select ?v_23 ?J_69) ?K_70) (select (select ?v_23 ?K_70) ?J_69)))))))))))))))))))))))))))))))
(check-sat)
(exit)
