...
(assert (not (= def use)))
(assert (not (=> true (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_1 (= 5 ?A_59)) (?v_2 (= 5 ?B_60))) (let ((?v_8 (not (and ?v_1 ?v_2))) (?v_4 (= 4 ?B_60))) (let ((?v_10 (not (and ?v_4 ?v_1))) (?v_5 (= 3 ?B_60))) (let ((?v_16 (not (and ?v_5 ?v_1))) (?v_6 (= 2 ?B_60))) (let ((?v_18 (not (and ?v_6 ?v_1))) (?v_7 (= 1 ?B_60))) (let ((?v_20 (not (and ?v_7 ?v_1))) (?v_3 (= 4 ?A_59))) (let ((?v_9 (not (and ?v_3 ?v_2))) (?v_11 (not (and ?v_3 ?v_4))) (?v_17 (not (and ?v_5 ?v_3))) (?v_19 (not (and ?v_6 ?v_3))) (?v_21 (and ?v_7 ?v_3)) (?v_12 (= 3 ?A_59)) (?v_13 (= 2 ?A_59)) (?v_14 (= 1 ?A_59)) (?v_15 (= 0 ?A_59)) (?v_0 (- 6 1))) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 ?v_0)) (<= ?B_60 ?v_0)) (=> ?v_8 (=> ?v_10 (=> ?v_16 (=> ?v_18 (=> ?v_20 (=> (not (and (= 0 ?B_60) ?v_1)) (=> ?v_9 (=> ?v_11 (=> ?v_17 (=> ?v_19 (=> ?v_21 (=> ?v_8 (=> ?v_9 (=> (not (and ?v_12 ?v_2)) (=> (not (and ?v_13 ?v_2)) (=> (not (and ?v_14 ?v_2)) (=> (not (and ?v_15 ?v_2)) (=> ?v_10 (=> ?v_11 (=> (not (and ?v_12 ?v_4)) (=> (not (and ?v_13 ?v_4)) (=> (not (and ?v_14 ?v_4)) (=> (not (and ?v_15 ?v_4)) (=> ?v_16 (=> ?v_17 (=> (not (and ?v_12 ?v_5)) (=> (not (and ?v_13 ?v_5)) (=> (not (and ?v_14 ?v_5)) (=> (not (and ?v_15 ?v_5)) (=> ?v_18 (=> ?v_19 (=> (not (and ?v_6 ?v_12)) (=> (not (and ?v_13 ?v_6)) (=> (not (and ?v_14 ?v_6)) (=> (not (and ?v_15 ?v_6)) (=> ?v_20 (=> (not ?v_21) (=> (not (and ?v_7 ?v_12)) (=> (not (and ?v_7 ?v_13)) (=> (and ?v_14 ?v_7) (= 0.0 (* (divide 1.0 400.0) (select sigma 1)))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
