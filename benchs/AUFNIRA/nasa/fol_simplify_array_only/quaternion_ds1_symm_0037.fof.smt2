...
(assert (not (= def use)))
(assert (not (=> true (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_3 (= 5 ?A_59)) (?v_2 (= 5 ?B_60))) (let ((?v_1 (and ?v_3 ?v_2)) (?v_4 (= 4 ?A_59)) (?v_6 (= 3 ?A_59)) (?v_7 (= 2 ?A_59)) (?v_8 (= 1 ?A_59)) (?v_9 (= 0 ?A_59)) (?v_5 (= 4 ?B_60)) (?v_10 (= 3 ?B_60)) (?v_11 (= 2 ?B_60)) (?v_12 (= 1 ?B_60)) (?v_13 (= 0 ?B_60)) (?v_0 (- 6 1))) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 ?v_0)) (<= ?B_60 ?v_0)) (=> ?v_1 (=> (not ?v_1) (=> (not (and ?v_4 ?v_2)) (=> (not (and ?v_6 ?v_2)) (=> (not (and ?v_7 ?v_2)) (=> (not (and ?v_8 ?v_2)) (=> (not (and ?v_9 ?v_2)) (=> (not (and ?v_5 ?v_3)) (=> (not (and ?v_4 ?v_5)) (=> (not (and ?v_6 ?v_5)) (=> (not (and ?v_7 ?v_5)) (=> (not (and ?v_8 ?v_5)) (=> (not (and ?v_9 ?v_5)) (=> (not (and ?v_10 ?v_3)) (=> (not (and ?v_10 ?v_4)) (=> (not (and ?v_6 ?v_10)) (=> (not (and ?v_7 ?v_10)) (=> (not (and ?v_8 ?v_10)) (=> (not (and ?v_9 ?v_10)) (=> (not (and ?v_11 ?v_3)) (=> (not (and ?v_11 ?v_4)) (=> (not (and ?v_11 ?v_6)) (=> (not (and ?v_7 ?v_11)) (=> (not (and ?v_8 ?v_11)) (=> (not (and ?v_9 ?v_11)) (=> (not (and ?v_12 ?v_3)) (=> (not (and ?v_12 ?v_4)) (=> (not (and ?v_12 ?v_6)) (=> (not (and ?v_12 ?v_7)) (=> (not (and ?v_8 ?v_12)) (=> (not (and ?v_9 ?v_12)) (=> (not (and ?v_13 ?v_3)) (=> (not (and ?v_13 ?v_4)) (=> (not (and ?v_13 ?v_6)) (=> (not (and ?v_13 ?v_7)) (=> (not (and ?v_13 ?v_8)) (=> (not (and ?v_9 ?v_13)) (= (* (divide 1.0 400.0) (select sigma 5)) (select (select q_ds1_filter ?B_60) ?A_59))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
