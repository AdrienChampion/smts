...
(assert (not (= def use)))
(assert (not (=> true (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_1 (= 5 ?A_59)) (?v_2 (= 5 ?B_60))) (let ((?v_9 (not (and ?v_1 ?v_2))) (?v_4 (= 4 ?B_60))) (let ((?v_11 (not (and ?v_4 ?v_1))) (?v_5 (= 3 ?B_60))) (let ((?v_17 (not (and ?v_5 ?v_1))) (?v_6 (= 2 ?B_60))) (let ((?v_19 (not (and ?v_6 ?v_1))) (?v_7 (= 1 ?B_60))) (let ((?v_21 (not (and ?v_7 ?v_1))) (?v_8 (= 0 ?B_60)) (?v_3 (= 4 ?A_59))) (let ((?v_10 (not (and ?v_3 ?v_2))) (?v_12 (not (and ?v_3 ?v_4))) (?v_18 (not (and ?v_5 ?v_3))) (?v_20 (not (and ?v_6 ?v_3))) (?v_22 (not (and ?v_7 ?v_3))) (?v_13 (= 3 ?A_59)) (?v_14 (= 2 ?A_59)) (?v_15 (= 1 ?A_59)) (?v_16 (= 0 ?A_59)) (?v_0 (- 6 1))) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 ?v_0)) (<= ?B_60 ?v_0)) (=> ?v_9 (=> ?v_11 (=> ?v_17 (=> ?v_19 (=> ?v_21 (=> (not (and ?v_8 ?v_1)) (=> ?v_10 (=> ?v_12 (=> ?v_18 (=> ?v_20 (=> ?v_22 (=> (and ?v_8 ?v_3) (=> ?v_9 (=> ?v_10 (=> (not (and ?v_13 ?v_2)) (=> (not (and ?v_14 ?v_2)) (=> (not (and ?v_15 ?v_2)) (=> (not (and ?v_16 ?v_2)) (=> ?v_11 (=> ?v_12 (=> (not (and ?v_13 ?v_4)) (=> (not (and ?v_14 ?v_4)) (=> (not (and ?v_15 ?v_4)) (=> (not (and ?v_16 ?v_4)) (=> ?v_17 (=> ?v_18 (=> (not (and ?v_13 ?v_5)) (=> (not (and ?v_14 ?v_5)) (=> (not (and ?v_15 ?v_5)) (=> (not (and ?v_16 ?v_5)) (=> ?v_19 (=> ?v_20 (=> (not (and ?v_6 ?v_13)) (=> (not (and ?v_14 ?v_6)) (=> (not (and ?v_15 ?v_6)) (=> (not (and ?v_16 ?v_6)) (=> ?v_21 (=> ?v_22 (=> (not (and ?v_7 ?v_13)) (=> (not (and ?v_7 ?v_14)) (=> (and ?v_15 ?v_7) (= 0.0 (* (divide 1.0 400.0) (select sigma 1))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
