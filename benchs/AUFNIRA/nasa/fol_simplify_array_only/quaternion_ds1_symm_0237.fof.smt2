...
(assert (not (= def use)))
(assert (not (=> true (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_1 (= 5 ?A_59)) (?v_2 (= 5 ?B_60))) (let ((?v_3 (not (and ?v_1 ?v_2))) (?v_7 (= 4 ?B_60))) (let ((?v_5 (not (and ?v_7 ?v_1))) (?v_13 (= 3 ?B_60))) (let ((?v_12 (not (and ?v_13 ?v_1))) (?v_6 (= 4 ?A_59))) (let ((?v_4 (and ?v_6 ?v_2)) (?v_8 (= 3 ?A_59)) (?v_9 (= 2 ?A_59)) (?v_10 (= 1 ?A_59)) (?v_11 (= 0 ?A_59)) (?v_0 (- 6 1))) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 ?v_0)) (<= ?B_60 ?v_0)) (=> ?v_3 (=> ?v_5 (=> ?v_12 (=> (not (and (= 2 ?B_60) ?v_1)) (=> (not (and (= 1 ?B_60) ?v_1)) (=> (not (and (= 0 ?B_60) ?v_1)) (=> ?v_4 (=> ?v_3 (=> (not ?v_4) (=> (not (and ?v_8 ?v_2)) (=> (not (and ?v_9 ?v_2)) (=> (not (and ?v_10 ?v_2)) (=> (not (and ?v_11 ?v_2)) (=> ?v_5 (=> (not (and ?v_6 ?v_7)) (=> (not (and ?v_8 ?v_7)) (=> (not (and ?v_9 ?v_7)) (=> (not (and ?v_10 ?v_7)) (=> (not (and ?v_11 ?v_7)) (=> ?v_12 (=> (not (and ?v_13 ?v_6)) (=> (and ?v_8 ?v_13) (= 0.0 (* (divide 1.0 400.0) (select sigma 3)))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
