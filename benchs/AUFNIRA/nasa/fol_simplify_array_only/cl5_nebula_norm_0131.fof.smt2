...
(assert (not (= def use)))
(assert (not (=> (and (and (and (>= pv10 0) (<= pv10 (- 135300 1))) (forall ((?A_59 Int)) (let ((?v_3 (select x pv10)) (?v_1 (select sigma ?A_59)) (?v_5 (select sigma tptp_sum_index)) (?v_6 (sqrt (* 2.0 tptp_pi))) (?v_2 (- 5 1))) (let ((?v_0 (- ?v_3 (select mu ?A_59))) (?v_4 (- ?v_3 (select mu tptp_sum_index)))) (=> (and (>= ?A_59 0) (<= ?A_59 (- (+ 1 ?v_2) 1))) (= (select (select q pv10) ?A_59) (divide (divide (* (exp (divide (divide (* ?v_0 ?v_0) tptp_minus_2) (* ?v_1 ?v_1))) (select rho ?A_59)) (* ?v_6 ?v_1)) (sum 0 ?v_2 (divide (* (exp (divide (divide (* ?v_4 ?v_4) tptp_minus_2) (* ?v_5 ?v_5))) (select rho tptp_sum_index)) (* ?v_6 ?v_5)))))))))) (forall ((?B_60 Int)) (=> (and (>= ?B_60 0) (<= ?B_60 (- pv10 1))) (= (sum 0 (- 5 1) (select (select q ?B_60) tptp_sum_index)) 1.0)))) (forall ((?C_61 Int)) (=> (and (>= ?C_61 0) (<= ?C_61 (- pv10 1))) (= (sum 0 (- 5 1) (select (select q ?C_61) tptp_sum_index)) 1.0))))))
(check-sat)
(exit)
