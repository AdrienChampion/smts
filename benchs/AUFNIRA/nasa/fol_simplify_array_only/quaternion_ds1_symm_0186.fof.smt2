...
(assert (not (= def use)))
(assert (not (=> true (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_1 (= 5 ?A_59))) (let ((?v_2 (and ?v_1 (= 5 ?B_60))) (?v_0 (- 6 1))) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 ?v_0)) (<= ?B_60 ?v_0)) (=> (not ?v_2) (=> (not (and (= 4 ?B_60) ?v_1)) (=> (not (and (= 3 ?B_60) ?v_1)) (=> (not (and (= 2 ?B_60) ?v_1)) (=> (not (and (= 1 ?B_60) ?v_1)) (=> (and (= 0 ?B_60) ?v_1) (=> ?v_2 (= 0.0 (* (divide 1.0 400.0) (select sigma 5)))))))))))))))))
(check-sat)
(exit)
