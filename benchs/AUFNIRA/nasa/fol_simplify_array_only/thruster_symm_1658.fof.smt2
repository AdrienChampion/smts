...
(assert (not (= def use)))
(assert (not (=> (and (>= (- 4 1) 0) (>= (- 1000 1) 0)) (forall ((?A_59 Real)) (=> (and (<= 0 7) (>= (- 1000 1) 0)) (forall ((?L_60 Real)) (let ((?v_0 (> pv5 0))) (let ((?v_1 (not ?v_0))) (=> (and (and (and (and (and (>= pv5 0) (<= pv5 588)) (forall ((?B_61 Int) (?C_62 Int)) (let ((?v_2 (- 6 1))) (=> (and (and (and (>= ?B_61 0) (>= ?C_62 0)) (<= ?B_61 ?v_2)) (<= ?C_62 ?v_2)) (= (select (select q_thruster_filter ?B_61) ?C_62) (select (select q_thruster_filter ?C_62) ?B_61)))))) (forall ((?D_63 Int) (?E_64 Int)) (let ((?v_3 (- 4 1))) (=> (and (and (and (>= ?D_63 0) (>= ?E_64 0)) (<= ?D_63 ?v_3)) (<= ?E_64 ?v_3)) (= (select (select r_thruster_filter ?D_63) ?E_64) (select (select r_thruster_filter ?E_64) ?D_63)))))) (forall ((?F_65 Int) (?G_66 Int)) (let ((?v_4 (- 6 1))) (=> (and (and (and (>= ?F_65 0) (>= ?G_66 0)) (<= ?F_65 ?v_4)) (<= ?G_66 ?v_4)) (= (select (select pminus_thruster_filter ?F_65) ?G_66) (select (select pminus_thruster_filter ?G_66) ?F_65)))))) (forall ((?H_67 Int)) (=> (and (>= ?H_67 0) (<= ?H_67 (- 6 1))) (forall ((?I_68 Int)) (=> (and (>= ?I_68 0) (<= ?I_68 (- 6 1))) (= (select (select id_thruster_filter ?H_67) ?I_68) (select (select id_thruster_filter ?I_68) ?H_67))))))) (=> ?v_0 (=> ?v_1 (=> ?v_0 (=> ?v_1 (forall ((?J_69 Int) (?K_70 Int)) (let ((?v_5 (- 6 1)) (?v_7 (select (select xhatmin_thruster_filter 0) 0))) (let ((?v_8 (sin ?v_7)) (?v_17 (select (select tr 4) pv5)) (?v_16 (select (select tr 3) pv5)) (?v_6 (cos ?v_7)) (?v_15 (select (select tr 6) pv5)) (?v_14 (select (select tr 5) pv5)) (?v_10 (select (select tr 1) pv5)) (?v_11 (select (select tr 2) pv5)) (?v_12 (select (select tr 0) pv5)) (?v_13 (select (select tr 7) pv5))) (let ((?v_19 (- (- (- (- (+ (* ?v_6 ?v_16) (+ (* ?v_6 ?v_17) (+ (* ?v_8 ?v_10) (* ?v_8 ?v_11)))) (* ?v_6 ?v_12)) (* ?v_6 ?v_13)) (* ?v_8 ?v_14)) (* ?v_8 ?v_15)))) (let ((?v_9 (store phi_thruster_filter 5 (store (select phi_thruster_filter 5) 0 (divide (* tptp_float_0_034 (* tptp_float_1_2 ?v_19)) tptp_float_70_707)))) (?v_21 (- (- (- (- (+ (* ?v_6 ?v_10) (+ (* ?v_6 ?v_11) (+ (* ?v_8 ?v_12) (* ?v_8 ?v_13)))) (* ?v_6 ?v_14)) (* ?v_6 ?v_15)) (* ?v_8 ?v_16)) (* ?v_8 ?v_17)))) (let ((?v_18 (store ?v_9 4 (store (select ?v_9 4) 0 (divide (* tptp_float_0_034 (* tptp_float_1_2 ?v_21)) tptp_float_70_707)))) (?v_26 (trans h_thruster_filter)) (?v_23 (store r_thruster_filter 3 (store (select r_thruster_filter 3) 3 (select (select rho 3) pv5))))) (let ((?v_24 (store ?v_23 2 (store (select ?v_23 2) 2 (select (select rho 2) pv5))))) (let ((?v_25 (store ?v_24 1 (store (select ?v_24 1) 1 (select (select rho 1) pv5))))) (let ((?v_27 (store ?v_25 0 (store (select ?v_25 0) 0 (select (select rho 0) pv5))))) (let ((?v_28 (tptp_mmul pminus_thruster_filter (tptp_mmul ?v_26 (inv (tptp_madd ?v_27 (tptp_mmul h_thruster_filter (tptp_mmul pminus_thruster_filter ?v_26)))))))) (let ((?v_29 (tptp_msub id_thruster_filter (tptp_mmul ?v_28 h_thruster_filter))) (?v_22 (divide (* tptp_float_0_034 tptp_float_0_034) 2.0))) (let ((?v_20 (store ?v_18 2 (store (select ?v_18 2) 0 (divide (* tptp_float_1_2 (* ?v_19 ?v_22)) tptp_float_70_707))))) (let ((?v_30 (store ?v_20 1 (store (select ?v_20 1) 0 (divide (* tptp_float_1_2 (* ?v_21 ?v_22)) tptp_float_70_707))))) (let ((?v_31 (tptp_madd q_thruster_filter (tptp_mmul ?v_30 (tptp_mmul (tptp_madd (tptp_mmul ?v_28 (tptp_mmul ?v_27 (trans ?v_28))) (tptp_mmul ?v_29 (tptp_mmul pminus_thruster_filter (trans ?v_29)))) (trans ?v_30)))))) (=> (and (and (and (>= ?J_69 0) (>= ?K_70 0)) (<= ?J_69 ?v_5)) (<= ?K_70 ?v_5)) (= (select (select ?v_31 ?J_69) ?K_70) (select (select ?v_31 ?K_70) ?J_69))))))))))))))))))))))))))))))
(check-sat)
(exit)
