...
(assert (not (= def use)))
(assert (not (=> true (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_1 (= 5 ?A_59)) (?v_2 (= 5 ?B_60))) (let ((?v_7 (not (and ?v_1 ?v_2))) (?v_4 (= 4 ?B_60))) (let ((?v_9 (not (and ?v_4 ?v_1))) (?v_5 (= 3 ?B_60))) (let ((?v_15 (not (and ?v_5 ?v_1))) (?v_6 (= 2 ?B_60))) (let ((?v_17 (not (and ?v_6 ?v_1))) (?v_3 (= 4 ?A_59))) (let ((?v_8 (not (and ?v_3 ?v_2))) (?v_10 (not (and ?v_3 ?v_4))) (?v_16 (not (and ?v_5 ?v_3))) (?v_18 (and ?v_6 ?v_3)) (?v_11 (= 3 ?A_59)) (?v_12 (= 2 ?A_59)) (?v_13 (= 1 ?A_59)) (?v_14 (= 0 ?A_59)) (?v_0 (- 6 1))) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 ?v_0)) (<= ?B_60 ?v_0)) (=> ?v_7 (=> ?v_9 (=> ?v_15 (=> ?v_17 (=> (not (and (= 1 ?B_60) ?v_1)) (=> (not (and (= 0 ?B_60) ?v_1)) (=> ?v_8 (=> ?v_10 (=> ?v_16 (=> ?v_18 (=> ?v_7 (=> ?v_8 (=> (not (and ?v_11 ?v_2)) (=> (not (and ?v_12 ?v_2)) (=> (not (and ?v_13 ?v_2)) (=> (not (and ?v_14 ?v_2)) (=> ?v_9 (=> ?v_10 (=> (not (and ?v_11 ?v_4)) (=> (not (and ?v_12 ?v_4)) (=> (not (and ?v_13 ?v_4)) (=> (not (and ?v_14 ?v_4)) (=> ?v_15 (=> ?v_16 (=> (not (and ?v_11 ?v_5)) (=> (not (and ?v_12 ?v_5)) (=> (not (and ?v_13 ?v_5)) (=> (not (and ?v_14 ?v_5)) (=> ?v_17 (=> (not ?v_18) (=> (not (and ?v_6 ?v_11)) (=> (and ?v_12 ?v_6) (= 0.0 (* (divide 1.0 400.0) (select sigma 2))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
