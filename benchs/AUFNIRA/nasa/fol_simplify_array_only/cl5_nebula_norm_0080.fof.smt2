...
(assert (not (= def use)))
(assert (let ((?v_1 (select sigma tptp_sum_index)) (?v_0 (- (select x pv10) (select mu tptp_sum_index))) (?v_2 (- 5 1))) (not (=> (and (and (and (and (and (and (and (and (= pv84 (sum 0 (- pv45 1) (divide (* (exp (divide (divide (* ?v_0 ?v_0) tptp_minus_2) (* ?v_1 ?v_1))) (select rho tptp_sum_index)) (* (sqrt (* 2.0 tptp_pi)) ?v_1)))) (>= pv10 0)) (>= pv45 0)) (>= pv47 0)) (<= pv10 (- 135300 1))) (<= pv45 ?v_2)) (<= pv47 ?v_2)) (forall ((?A_59 Int)) (let ((?v_5 (select x pv10)) (?v_6 (sqrt (* 2.0 tptp_pi))) (?v_4 (select sigma ?A_59))) (let ((?v_3 (- ?v_5 (select mu ?A_59)))) (=> (and (>= ?A_59 0) (<= ?A_59 (- pv47 1))) (= (select (select q pv10) ?A_59) (divide (divide (* (exp (divide (divide (* ?v_3 ?v_3) tptp_minus_2) (* ?v_4 ?v_4))) (select rho ?A_59)) (* ?v_6 ?v_4)) (sum 0 ?v_2 (divide (* (exp (divide (divide (* ?v_0 ?v_0) tptp_minus_2) (* ?v_1 ?v_1))) (select rho tptp_sum_index)) (* ?v_6 ?v_1)))))))))) (forall ((?B_60 Int)) (=> (and (>= ?B_60 0) (<= ?B_60 (- pv10 1))) (= (sum 0 ?v_2 (select (select q ?B_60) tptp_sum_index)) 1.0)))) (forall ((?C_61 Int)) (let ((?v_9 (select x pv10)) (?v_10 (sqrt (* 2.0 tptp_pi))) (?v_8 (select sigma ?C_61))) (let ((?v_7 (- ?v_9 (select mu ?C_61)))) (=> (and (>= ?C_61 0) (<= ?C_61 (- pv47 1))) (= (select (select q pv10) ?C_61) (divide (divide (* (exp (divide (divide (* ?v_7 ?v_7) tptp_minus_2) (* ?v_8 ?v_8))) (select rho ?C_61)) (* ?v_10 ?v_8)) (sum 0 ?v_2 (divide (* (exp (divide (divide (* ?v_0 ?v_0) tptp_minus_2) (* ?v_1 ?v_1))) (select rho tptp_sum_index)) (* ?v_10 ?v_1)))))))))))))
(check-sat)
(exit)
