...
(assert (not (= def use)))
(assert (not (=> true (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_1 (= 5 ?A_59)) (?v_2 (= 5 ?B_60))) (let ((?v_11 (not (and ?v_1 ?v_2))) (?v_4 (= 4 ?B_60))) (let ((?v_16 (not (and ?v_4 ?v_1))) (?v_5 (= 3 ?B_60))) (let ((?v_22 (not (and ?v_5 ?v_1))) (?v_6 (= 2 ?B_60))) (let ((?v_26 (not (and ?v_6 ?v_1))) (?v_7 (= 1 ?B_60))) (let ((?v_30 (not (and ?v_7 ?v_1))) (?v_8 (= 0 ?B_60))) (let ((?v_34 (not (and ?v_8 ?v_1))) (?v_3 (= 4 ?A_59))) (let ((?v_12 (not (and ?v_3 ?v_2))) (?v_17 (not (and ?v_3 ?v_4))) (?v_23 (not (and ?v_5 ?v_3))) (?v_27 (not (and ?v_6 ?v_3))) (?v_31 (not (and ?v_7 ?v_3))) (?v_35 (not (and ?v_8 ?v_3))) (?v_9 (= 3 ?A_59))) (let ((?v_13 (not (and ?v_9 ?v_2))) (?v_18 (not (and ?v_9 ?v_4))) (?v_24 (not (and ?v_9 ?v_5))) (?v_28 (not (and ?v_6 ?v_9))) (?v_32 (not (and ?v_7 ?v_9))) (?v_36 (not (and ?v_8 ?v_9))) (?v_10 (= 2 ?A_59))) (let ((?v_14 (not (and ?v_10 ?v_2))) (?v_19 (not (and ?v_10 ?v_4))) (?v_25 (not (and ?v_10 ?v_5))) (?v_29 (not (and ?v_10 ?v_6))) (?v_33 (not (and ?v_7 ?v_10))) (?v_37 (not (and ?v_8 ?v_10))) (?v_20 (= 1 ?A_59))) (let ((?v_15 (and ?v_20 ?v_2)) (?v_21 (= 0 ?A_59)) (?v_0 (- 6 1))) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 ?v_0)) (<= ?B_60 ?v_0)) (=> ?v_11 (=> ?v_16 (=> ?v_22 (=> ?v_26 (=> ?v_30 (=> ?v_34 (=> ?v_12 (=> ?v_17 (=> ?v_23 (=> ?v_27 (=> ?v_31 (=> ?v_35 (=> ?v_13 (=> ?v_18 (=> ?v_24 (=> ?v_28 (=> ?v_32 (=> ?v_36 (=> ?v_14 (=> ?v_19 (=> ?v_25 (=> ?v_29 (=> ?v_33 (=> ?v_37 (=> ?v_15 (=> ?v_11 (=> ?v_12 (=> ?v_13 (=> ?v_14 (=> (not ?v_15) (=> (not (and ?v_21 ?v_2)) (=> ?v_16 (=> ?v_17 (=> ?v_18 (=> ?v_19 (=> (not (and ?v_20 ?v_4)) (=> (not (and ?v_21 ?v_4)) (=> ?v_22 (=> ?v_23 (=> ?v_24 (=> ?v_25 (=> (not (and ?v_20 ?v_5)) (=> (not (and ?v_21 ?v_5)) (=> ?v_26 (=> ?v_27 (=> ?v_28 (=> ?v_29 (=> (not (and ?v_20 ?v_6)) (=> (not (and ?v_21 ?v_6)) (=> ?v_30 (=> ?v_31 (=> ?v_32 (=> ?v_33 (=> (not (and ?v_20 ?v_7)) (=> (not (and ?v_21 ?v_7)) (=> ?v_34 (=> ?v_35 (=> ?v_36 (=> ?v_37 (=> (not (and ?v_8 ?v_20)) (=> (and ?v_21 ?v_8) (= 0.0 (* (divide 1.0 400.0) (select sigma 0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
