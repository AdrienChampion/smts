...
(assert (not (= def use)))
(assert (not (=> true (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_1 (and (= 5 ?A_59) (= 5 ?B_60))) (?v_0 (- 6 1)) (?v_2 (* (divide 1.0 400.0) (select sigma 5)))) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 ?v_0)) (<= ?B_60 ?v_0)) (=> ?v_1 (=> ?v_1 (= ?v_2 ?v_2)))))))))
(check-sat)
(exit)
