...
(assert (not (= def use)))
(assert (not (=> true (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_1 (= 5 ?A_59)) (?v_3 (= 5 ?B_60))) (let ((?v_2 (not (and ?v_1 ?v_3))) (?v_6 (= 4 ?B_60))) (let ((?v_4 (not (and ?v_6 ?v_1))) (?v_12 (= 3 ?B_60))) (let ((?v_11 (and ?v_12 ?v_1)) (?v_5 (= 4 ?A_59)) (?v_7 (= 3 ?A_59)) (?v_8 (= 2 ?A_59)) (?v_9 (= 1 ?A_59)) (?v_10 (= 0 ?A_59)) (?v_13 (= 2 ?B_60)) (?v_14 (= 1 ?B_60)) (?v_15 (= 0 ?B_60)) (?v_0 (- 6 1))) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 ?v_0)) (<= ?B_60 ?v_0)) (=> ?v_2 (=> ?v_4 (=> ?v_11 (=> ?v_2 (=> (not (and ?v_5 ?v_3)) (=> (not (and ?v_7 ?v_3)) (=> (not (and ?v_8 ?v_3)) (=> (not (and ?v_9 ?v_3)) (=> (not (and ?v_10 ?v_3)) (=> ?v_4 (=> (not (and ?v_5 ?v_6)) (=> (not (and ?v_7 ?v_6)) (=> (not (and ?v_8 ?v_6)) (=> (not (and ?v_9 ?v_6)) (=> (not (and ?v_10 ?v_6)) (=> (not ?v_11) (=> (not (and ?v_12 ?v_5)) (=> (not (and ?v_7 ?v_12)) (=> (not (and ?v_8 ?v_12)) (=> (not (and ?v_9 ?v_12)) (=> (not (and ?v_10 ?v_12)) (=> (not (and ?v_13 ?v_1)) (=> (not (and ?v_13 ?v_5)) (=> (not (and ?v_13 ?v_7)) (=> (not (and ?v_8 ?v_13)) (=> (not (and ?v_9 ?v_13)) (=> (not (and ?v_10 ?v_13)) (=> (not (and ?v_14 ?v_1)) (=> (not (and ?v_14 ?v_5)) (=> (not (and ?v_14 ?v_7)) (=> (not (and ?v_14 ?v_8)) (=> (not (and ?v_9 ?v_14)) (=> (not (and ?v_10 ?v_14)) (=> (not (and ?v_15 ?v_1)) (=> (not (and ?v_15 ?v_5)) (=> (not (and ?v_15 ?v_7)) (=> (not (and ?v_15 ?v_8)) (=> (not (and ?v_15 ?v_9)) (=> (and ?v_10 ?v_15) (= 0.0 (* (divide 1.0 400.0) (select sigma 0)))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
