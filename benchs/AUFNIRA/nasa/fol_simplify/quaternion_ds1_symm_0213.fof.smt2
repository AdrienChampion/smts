...
(assert (not (= def use)))
(assert (not (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_0 (= 0 ?A_59)) (?v_1 (= 3 ?B_60)) (?v_3 (= 4 ?B_60)) (?v_4 (= 5 ?B_60)) (?v_2 (= 1 ?A_59)) (?v_5 (= 2 ?A_59)) (?v_6 (= 2 ?B_60)) (?v_7 (= 3 ?A_59)) (?v_8 (= 4 ?A_59)) (?v_9 (= 5 ?A_59))) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 5)) (<= ?B_60 5)) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (not (and ?v_0 ?v_1)) (not (and ?v_0 ?v_3))) (not (and ?v_0 ?v_4))) (not (and ?v_2 ?v_1))) (not (and ?v_2 ?v_3))) (not (and ?v_2 ?v_4))) (not (and ?v_5 ?v_1))) (not (and ?v_5 ?v_3))) (not (and ?v_5 ?v_4))) (not (and ?v_6 ?v_7))) (not (and ?v_6 ?v_8))) (not (and ?v_6 ?v_9))) (not (and ?v_7 ?v_1))) (not (and ?v_7 ?v_3))) (not (and ?v_7 ?v_4))) (not (and ?v_1 ?v_8))) (not (and ?v_1 ?v_9))) (not (and ?v_8 ?v_3))) (not (and ?v_8 ?v_4))) (not (and ?v_3 ?v_9))) (not (and ?v_9 ?v_4))) ?v_5) ?v_6) ?v_1) ?v_9) (= 0.0 (* (divide 1.0 400.0) (select sigma 2)))))))))
(check-sat)
(exit)
