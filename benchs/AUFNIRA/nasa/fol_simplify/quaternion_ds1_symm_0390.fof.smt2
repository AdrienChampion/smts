...
(assert (not (= def use)))
(assert (not (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_0 (= 5 ?A_59)) (?v_1 (= 5 ?B_60))) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 5)) (<= ?B_60 5)) (=> (and (and (and (not (and ?v_0 ?v_1)) (= 4 ?B_60)) ?v_0) ?v_1) (= 0.0 (* (divide 1.0 400.0) (select sigma 5)))))))))
(check-sat)
(exit)
