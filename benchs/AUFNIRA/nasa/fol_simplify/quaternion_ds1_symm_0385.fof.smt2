...
(assert (not (= def use)))
(assert (not (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_0 (= 5 ?B_60)) (?v_1 (= 5 ?A_59))) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 5)) (<= ?B_60 5)) (=> (and (and (and (and (and (not (and (= 3 ?A_59) ?v_0)) (not (and (= 4 ?A_59) ?v_0))) (not (and ?v_1 ?v_0))) (= 2 ?A_59)) ?v_1) ?v_0) (= (* (divide 1.0 400.0) (select sigma 5)) 0.0)))))))
(check-sat)
(exit)
