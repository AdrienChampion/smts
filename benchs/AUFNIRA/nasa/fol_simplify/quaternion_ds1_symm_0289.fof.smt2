...
(assert (not (= def use)))
(assert (not (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_2 (= 5 ?B_60)) (?v_0 (= 0 ?B_60)) (?v_3 (= 2 ?A_59)) (?v_5 (= 3 ?A_59)) (?v_6 (= 4 ?A_59)) (?v_7 (= 5 ?A_59)) (?v_1 (= 1 ?A_59)) (?v_8 (= 3 ?B_60)) (?v_9 (= 4 ?B_60)) (?v_4 (= 1 ?B_60)) (?v_10 (= 2 ?B_60))) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 5)) (<= ?B_60 5)) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (not (and (= 0 ?A_59) ?v_2)) (not (and ?v_0 ?v_3))) (not (and ?v_0 ?v_5))) (not (and ?v_0 ?v_6))) (not (and ?v_0 ?v_7))) (not (and ?v_1 ?v_8))) (not (and ?v_1 ?v_9))) (not (and ?v_1 ?v_2))) (not (and ?v_4 ?v_3))) (not (and ?v_4 ?v_5))) (not (and ?v_4 ?v_6))) (not (and ?v_4 ?v_7))) (not (and ?v_3 ?v_10))) (not (and ?v_3 ?v_8))) (not (and ?v_3 ?v_9))) (not (and ?v_3 ?v_2))) (not (and ?v_10 ?v_5))) (not (and ?v_10 ?v_6))) (not (and ?v_10 ?v_7))) (not (and ?v_5 ?v_8))) (not (and ?v_5 ?v_9))) (not (and ?v_5 ?v_2))) (not (and ?v_8 ?v_6))) (not (and ?v_8 ?v_7))) (not (and ?v_6 ?v_9))) (not (and ?v_6 ?v_2))) (not (and ?v_9 ?v_7))) (not (and ?v_7 ?v_2))) ?v_1) ?v_10) ?v_6) ?v_9) (= 0.0 (* (divide 1.0 400.0) (select sigma 4)))))))))
(check-sat)
(exit)
