...
(assert (not (= def use)))
(assert (not (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_0 (= 0 ?A_59)) (?v_2 (= 2 ?B_60)) (?v_4 (= 3 ?B_60)) (?v_5 (= 4 ?B_60)) (?v_6 (= 5 ?B_60)) (?v_1 (= 0 ?B_60)) (?v_8 (= 3 ?A_59)) (?v_9 (= 4 ?A_59)) (?v_10 (= 5 ?A_59)) (?v_3 (= 1 ?A_59)) (?v_7 (= 1 ?B_60)) (?v_11 (= 2 ?A_59)) (?v_12 (divide 1.0 400.0))) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 5)) (<= ?B_60 5)) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (not (and ?v_0 ?v_2)) (not (and ?v_0 ?v_4))) (not (and ?v_0 ?v_5))) (not (and ?v_0 ?v_6))) (not (and ?v_1 ?v_8))) (not (and ?v_1 ?v_9))) (not (and ?v_1 ?v_10))) (not (and ?v_3 ?v_2))) (not (and ?v_3 ?v_4))) (not (and ?v_3 ?v_5))) (not (and ?v_3 ?v_6))) (not (and ?v_7 ?v_11))) (not (and ?v_7 ?v_8))) (not (and ?v_7 ?v_9))) (not (and ?v_7 ?v_10))) (not (and ?v_11 ?v_2))) (not (and ?v_11 ?v_4))) (not (and ?v_11 ?v_5))) (not (and ?v_11 ?v_6))) (not (and ?v_2 ?v_8))) (not (and ?v_2 ?v_9))) (not (and ?v_2 ?v_10))) (not (and ?v_8 ?v_4))) (not (and ?v_8 ?v_5))) (not (and ?v_8 ?v_6))) (not (and ?v_4 ?v_9))) (not (and ?v_4 ?v_10))) (not (and ?v_9 ?v_5))) (not (and ?v_9 ?v_6))) (not (and ?v_5 ?v_10))) (not (and ?v_10 ?v_6))) ?v_3) ?v_7) ?v_11) ?v_2) (= (* ?v_12 (select sigma 2)) (* ?v_12 (select sigma 1)))))))))
(check-sat)
(exit)
