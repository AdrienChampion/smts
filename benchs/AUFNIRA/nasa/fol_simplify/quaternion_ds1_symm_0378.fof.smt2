...
(assert (not (= def use)))
(assert (not (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_0 (= 5 ?A_59)) (?v_2 (= 4 ?A_59)) (?v_1 (= 5 ?B_60)) (?v_3 (= 4 ?B_60)) (?v_4 (divide 1.0 400.0))) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 5)) (<= ?B_60 5)) (=> (and (and (and (and (and (and (and (and (and (and (not (and (= 0 ?B_60) ?v_0)) (not (and (= 1 ?B_60) ?v_0))) (not (and (= 2 ?B_60) ?v_0))) (not (and (= 3 ?B_60) ?v_0))) (not (and ?v_2 ?v_1))) (not (and ?v_3 ?v_0))) (not (and ?v_0 ?v_1))) ?v_2) ?v_3) ?v_0) ?v_1) (= (* ?v_4 (select sigma 4)) (* ?v_4 (select sigma 5)))))))))
(check-sat)
(exit)
