...
(assert (not (= def use)))
(assert (let ((?v_0 (and (>= pv10 0) (<= pv10 (- 135300 1))))) (not (=> (and ?v_0 (forall ((?A_59 Int) (?B_60 Int)) (=> (and (>= ?A_59 0) (<= ?A_59 (- pv10 1))) (= (sum 0 (- 5 1) (select (select q ?A_59) ?B_60)) 1.0)))) (and (and ?v_0 (forall ((?C_61 Int) (?D_62 Int)) (let ((?v_2 (select x pv10))) (let ((?v_1 (- (select (select center ?C_61) 0) ?v_2)) (?v_3 (- (select (select center ?D_62) 0) ?v_2))) (=> (and (>= ?C_61 0) (<= ?C_61 (- 0 1))) (= (select (select q pv10) ?C_61) (divide (sqrt (* ?v_1 ?v_1)) (sum 0 (- 5 1) (sqrt (* ?v_3 ?v_3)))))))))) (forall ((?E_63 Int) (?F_64 Int)) (=> (and (>= ?E_63 0) (<= ?E_63 (- pv10 1))) (= (sum 0 (- 5 1) (select (select q ?E_63) ?F_64)) 1.0))))))))
(check-sat)
(exit)
