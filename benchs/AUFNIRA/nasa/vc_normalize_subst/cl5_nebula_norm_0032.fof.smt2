...
(assert (not (= def use)))
(assert (let ((?v_2 (>= pv10 0)) (?v_3 (>= pv47 0)) (?v_4 (<= pv10 (- 135300 1))) (?v_5 (<= pv47 (- 5 1))) (?v_1 (select sigma pv85)) (?v_0 (- (select x pv10) (select mu pv85)))) (not (=> (and (and (and (and (and ?v_2 ?v_3) ?v_4) ?v_5) (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_8 (select x pv10)) (?v_7 (select sigma ?A_59)) (?v_10 (select sigma ?B_60)) (?v_11 (sqrt (* tptp_pi 2.0)))) (let ((?v_6 (- ?v_8 (select mu ?A_59))) (?v_9 (- ?v_8 (select mu ?B_60)))) (=> (and (>= ?A_59 0) (<= ?A_59 (- pv47 1))) (= (select (select q pv10) ?A_59) (divide (divide (* (exp (divide (divide (* ?v_6 ?v_6) tptp_minus_2) (* ?v_7 ?v_7))) (select rho ?A_59)) (* ?v_11 ?v_7)) (sum 0 (- 5 1) (divide (* (exp (divide (divide (* ?v_9 ?v_9) tptp_minus_2) (* ?v_10 ?v_10))) (select rho ?B_60)) (* ?v_11 ?v_10)))))))))) (forall ((?C_61 Int) (?D_62 Int)) (=> (and (>= ?C_61 0) (<= ?C_61 (- pv10 1))) (= (sum 0 (- 5 1) (select (select q ?C_61) ?D_62)) 1.0)))) (and (and (and (and (and (and (= 0.0 (sum 0 (- 0 1) (divide (* (exp (divide (divide (* ?v_0 ?v_0) tptp_minus_2) (* ?v_1 ?v_1))) (select rho pv85)) (* (sqrt (* tptp_pi 2.0)) ?v_1)))) ?v_2) ?v_3) ?v_4) ?v_5) (forall ((?E_63 Int) (?F_64 Int)) (let ((?v_14 (select x pv10)) (?v_17 (sqrt (* tptp_pi 2.0))) (?v_13 (select sigma ?E_63)) (?v_16 (select sigma ?F_64))) (let ((?v_12 (- ?v_14 (select mu ?E_63))) (?v_15 (- ?v_14 (select mu ?F_64)))) (=> (and (>= ?E_63 0) (<= ?E_63 (- pv47 1))) (= (select (select q pv10) ?E_63) (divide (divide (* (exp (divide (divide (* ?v_12 ?v_12) tptp_minus_2) (* ?v_13 ?v_13))) (select rho ?E_63)) (* ?v_17 ?v_13)) (sum 0 (- 5 1) (divide (* (exp (divide (divide (* ?v_15 ?v_15) tptp_minus_2) (* ?v_16 ?v_16))) (select rho ?F_64)) (* ?v_17 ?v_16)))))))))) (forall ((?G_65 Int) (?H_66 Int)) (=> (and (>= ?G_65 0) (<= ?G_65 (- pv10 1))) (= (sum 0 (- 5 1) (select (select q ?G_65) ?H_66)) 1.0))))))))
(check-sat)
(exit)
