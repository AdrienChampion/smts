...
(assert (not (= def use)))
(assert (let ((?v_1 (>= pv10 0)) (?v_2 (>= pv12 0)) (?v_3 (<= pv10 (- 135300 1))) (?v_4 (<= pv12 (- 5 1))) (?v_0 (- (select (select center pv71) 0) (select x pv10)))) (not (=> (and (and (and (and (and ?v_1 ?v_2) ?v_3) ?v_4) (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_6 (select x pv10))) (let ((?v_5 (- (select (select center ?A_59) 0) ?v_6)) (?v_7 (- (select (select center ?B_60) 0) ?v_6))) (=> (and (>= ?A_59 0) (<= ?A_59 (- pv12 1))) (= (select (select q pv10) ?A_59) (divide (sqrt (* ?v_5 ?v_5)) (sum 0 (- 5 1) (sqrt (* ?v_7 ?v_7)))))))))) (forall ((?C_61 Int) (?D_62 Int)) (=> (and (>= ?C_61 0) (<= ?C_61 (- pv10 1))) (= (sum 0 (- 5 1) (select (select q ?C_61) ?D_62)) 1.0)))) (and (and (and (and (and (and (= 0.0 (sum 0 (- 0 1) (sqrt (* ?v_0 ?v_0)))) ?v_1) ?v_2) ?v_3) ?v_4) (forall ((?E_63 Int) (?F_64 Int)) (let ((?v_9 (select x pv10))) (let ((?v_8 (- (select (select center ?E_63) 0) ?v_9)) (?v_10 (- (select (select center ?F_64) 0) ?v_9))) (=> (and (>= ?E_63 0) (<= ?E_63 (- pv12 1))) (= (select (select q pv10) ?E_63) (divide (sqrt (* ?v_8 ?v_8)) (sum 0 (- 5 1) (sqrt (* ?v_10 ?v_10)))))))))) (forall ((?G_65 Int) (?H_66 Int)) (=> (and (>= ?G_65 0) (<= ?G_65 (- pv10 1))) (= (sum 0 (- 5 1) (select (select q ?G_65) ?H_66)) 1.0))))))))
(check-sat)
(exit)
