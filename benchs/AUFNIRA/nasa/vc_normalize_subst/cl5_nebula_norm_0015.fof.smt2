...
(declare-fun pv41 () Int)
(declare-fun pv78 () Real)
(declare-fun pv79 () Int)
(declare-fun pv82 () Real)
...
(assert (not (= def use)))
(assert (let ((?v_1 (- 135300 1))) (let ((?v_5 (= pv78 (sum 0 ?v_1 (select (select q pv79) pv35)))) (?v_2 (select mu pv35)) (?v_6 (>= pv35 0)) (?v_7 (<= pv35 (- 5 1)))) (let ((?v_0 (- (select x pv83) ?v_2))) (let ((?v_4 (* ?v_0 (* ?v_0 (select (select q pv83) pv35)))) (?v_3 (- (select x pv41) ?v_2))) (not (=> (and (and (and (and (and ?v_5 (= pv82 (sum 0 (- pv41 1) ?v_4))) ?v_6) (>= pv41 0)) ?v_7) (<= pv41 ?v_1)) (and (and (and (= (+ (* ?v_3 (* ?v_3 (select (select q pv41) pv35))) pv82) (sum 0 (- (+ 1 pv41) 1) ?v_4)) ?v_5) ?v_6) ?v_7))))))))
(check-sat)
(exit)
