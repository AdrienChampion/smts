...
(assert (not (= def use)))
(assert (let ((?v_1 (select sigma pv85)) (?v_4 (>= pv10 0)) (?v_5 (>= pv47 0)) (?v_6 (<= pv10 (- 135300 1))) (?v_2 (- 5 1))) (let ((?v_7 (<= pv47 ?v_2)) (?v_0 (- (select x pv10) (select mu pv85)))) (let ((?v_3 (divide (* (exp (divide (divide (* ?v_0 ?v_0) tptp_minus_2) (* ?v_1 ?v_1))) (select rho pv85)) (* (sqrt (* tptp_pi 2.0)) ?v_1)))) (not (=> (and (and (and (and (and (and (= pv84 (sum 0 (- (+ 1 ?v_2) 1) ?v_3)) ?v_4) ?v_5) ?v_6) ?v_7) (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_10 (select x pv10)) (?v_13 (sqrt (* tptp_pi 2.0))) (?v_9 (select sigma ?A_59)) (?v_12 (select sigma ?B_60))) (let ((?v_8 (- ?v_10 (select mu ?A_59))) (?v_11 (- ?v_10 (select mu ?B_60)))) (=> (and (>= ?A_59 0) (<= ?A_59 (- pv47 1))) (= (select (select q pv10) ?A_59) (divide (divide (* (exp (divide (divide (* ?v_8 ?v_8) tptp_minus_2) (* ?v_9 ?v_9))) (select rho ?A_59)) (* ?v_13 ?v_9)) (sum 0 ?v_2 (divide (* (exp (divide (divide (* ?v_11 ?v_11) tptp_minus_2) (* ?v_12 ?v_12))) (select rho ?B_60)) (* ?v_13 ?v_12)))))))))) (forall ((?C_61 Int) (?D_62 Int)) (=> (and (>= ?C_61 0) (<= ?C_61 (- pv10 1))) (= (sum 0 ?v_2 (select (select q ?C_61) ?D_62)) 1.0)))) (and (and (and (and (and (and (= pv84 (sum 0 ?v_2 ?v_3)) ?v_4) ?v_5) ?v_6) ?v_7) (forall ((?E_63 Int) (?F_64 Int)) (let ((?v_16 (select x pv10)) (?v_19 (sqrt (* tptp_pi 2.0))) (?v_15 (select sigma ?E_63)) (?v_18 (select sigma ?F_64))) (let ((?v_14 (- ?v_16 (select mu ?E_63))) (?v_17 (- ?v_16 (select mu ?F_64)))) (=> (and (>= ?E_63 0) (<= ?E_63 (- pv47 1))) (= (select (select q pv10) ?E_63) (divide (divide (* (exp (divide (divide (* ?v_14 ?v_14) tptp_minus_2) (* ?v_15 ?v_15))) (select rho ?E_63)) (* ?v_19 ?v_15)) (sum 0 ?v_2 (divide (* (exp (divide (divide (* ?v_17 ?v_17) tptp_minus_2) (* ?v_18 ?v_18))) (select rho ?F_64)) (* ?v_19 ?v_18)))))))))) (forall ((?G_65 Int) (?H_66 Int)) (=> (and (>= ?G_65 0) (<= ?G_65 (- pv10 1))) (= (sum 0 ?v_2 (select (select q ?G_65) ?H_66)) 1.0))))))))))
(check-sat)
(exit)
