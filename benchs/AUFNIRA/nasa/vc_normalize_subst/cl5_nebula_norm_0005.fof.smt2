...
(assert (not (= def use)))
(assert (let ((?v_0 (- (select (select center pv71) 0) (select x pv10)))) (let ((?v_2 (sqrt (* ?v_0 ?v_0))) (?v_3 (>= pv10 0)) (?v_4 (>= pv12 0)) (?v_5 (<= pv10 (- 135300 1))) (?v_1 (- 5 1))) (let ((?v_6 (<= pv12 ?v_1))) (not (=> (and (and (and (and (and (and (= pv70 (sum 0 (- (+ 1 ?v_1) 1) ?v_2)) ?v_3) ?v_4) ?v_5) ?v_6) (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_8 (select x pv10))) (let ((?v_7 (- (select (select center ?A_59) 0) ?v_8)) (?v_9 (- (select (select center ?B_60) 0) ?v_8))) (=> (and (>= ?A_59 0) (<= ?A_59 (- pv12 1))) (= (select (select q pv10) ?A_59) (divide (sqrt (* ?v_7 ?v_7)) (sum 0 ?v_1 (sqrt (* ?v_9 ?v_9)))))))))) (forall ((?C_61 Int) (?D_62 Int)) (=> (and (>= ?C_61 0) (<= ?C_61 (- pv10 1))) (= (sum 0 ?v_1 (select (select q ?C_61) ?D_62)) 1.0)))) (and (and (and (and (and (and (= pv70 (sum 0 ?v_1 ?v_2)) ?v_3) ?v_4) ?v_5) ?v_6) (forall ((?E_63 Int) (?F_64 Int)) (let ((?v_11 (select x pv10))) (let ((?v_10 (- (select (select center ?E_63) 0) ?v_11)) (?v_12 (- (select (select center ?F_64) 0) ?v_11))) (=> (and (>= ?E_63 0) (<= ?E_63 (- pv12 1))) (= (select (select q pv10) ?E_63) (divide (sqrt (* ?v_10 ?v_10)) (sum 0 ?v_1 (sqrt (* ?v_12 ?v_12)))))))))) (forall ((?G_65 Int) (?H_66 Int)) (=> (and (>= ?G_65 0) (<= ?G_65 (- pv10 1))) (= (sum 0 ?v_1 (select (select q ?G_65) ?H_66)) 1.0))))))))))
(check-sat)
(exit)
