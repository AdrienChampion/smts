...
(declare-fun pv35 () Int)
(declare-fun pv44 () Real)
(declare-fun pv78 () Real)
(declare-fun pv79 () Int)
(declare-fun pv80 () Real)
(declare-fun pv81 () Int)
(declare-fun pv83 () Int)
...
(assert (not (= def use)))
(assert (let ((?v_1 0.0) (?v_0 (- 135300 1))) (let ((?v_3 (= pv78 (sum 0 ?v_0 (select (select q pv79) pv35)))) (?v_4 (>= pv35 0)) (?v_5 (<= pv35 (- 5 1))) (?v_6 (= ?v_1 pv44)) (?v_2 (- (select x pv83) (select (store mu pv35 (divide pv80 pv44)) pv35)))) (not (=> (and (and (and ?v_3 (= pv80 (sum 0 ?v_0 (* (select (select q pv81) pv35) (select x pv81))))) ?v_4) ?v_5) (and (=> (not ?v_6) (and (and (and (= ?v_1 (sum 0 (- 0 1) (* ?v_2 (* ?v_2 (select (select q pv83) pv35))))) ?v_3) ?v_4) ?v_5)) (=> ?v_6 true)))))))
(check-sat)
(exit)
