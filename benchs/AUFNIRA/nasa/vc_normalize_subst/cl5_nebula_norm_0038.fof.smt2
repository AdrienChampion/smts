...
(assert (not (= def use)))
(assert (let ((?v_0 (>= pv10 0)) (?v_1 (<= pv10 (- 135300 1)))) (not (=> (and (and (and ?v_0 ?v_1) (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_5 (select x pv10)) (?v_3 (select sigma ?A_59)) (?v_7 (select sigma ?B_60)) (?v_8 (sqrt (* tptp_pi 2.0))) (?v_4 (- 5 1))) (let ((?v_2 (- ?v_5 (select mu ?A_59))) (?v_6 (- ?v_5 (select mu ?B_60)))) (=> (and (>= ?A_59 0) (<= ?A_59 (- (+ 1 ?v_4) 1))) (= (select (select q pv10) ?A_59) (divide (divide (* (exp (divide (divide (* ?v_2 ?v_2) tptp_minus_2) (* ?v_3 ?v_3))) (select rho ?A_59)) (* ?v_8 ?v_3)) (sum 0 ?v_4 (divide (* (exp (divide (divide (* ?v_6 ?v_6) tptp_minus_2) (* ?v_7 ?v_7))) (select rho ?B_60)) (* ?v_8 ?v_7)))))))))) (forall ((?C_61 Int) (?D_62 Int)) (=> (and (>= ?C_61 0) (<= ?C_61 (- pv10 1))) (= (sum 0 (- 5 1) (select (select q ?C_61) ?D_62)) 1.0)))) (and (and (and (= (sum 0 (- 5 1) (select (select q pv10) pv52)) 1.0) ?v_0) ?v_1) (forall ((?E_63 Int) (?F_64 Int)) (=> (and (>= ?E_63 0) (<= ?E_63 (- pv10 1))) (= (sum 0 (- 5 1) (select (select q ?E_63) ?F_64)) 1.0))))))))
(check-sat)
(exit)
