...
(assert (not (= def use)))
(assert (let ((?v_0 0.0) (?v_1 (= pv78 (sum 0 (- 135300 1) (select (select q pv79) pv35)))) (?v_2 (>= pv35 0)) (?v_3 (<= pv35 (- 5 1)))) (let ((?v_4 (= ?v_0 pv78))) (not (=> (and (and ?v_1 ?v_2) ?v_3) (and (=> (not ?v_4) (and (and (and (= ?v_0 (sum 0 (- 0 1) (* (select (select q pv81) pv35) (select x pv81)))) ?v_1) ?v_2) ?v_3)) (=> ?v_4 true)))))))
(check-sat)
(exit)
