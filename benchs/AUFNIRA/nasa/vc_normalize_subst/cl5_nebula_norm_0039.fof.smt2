...
(assert (not (= def use)))
(assert (let ((?v_0 (and (>= pv10 0) (<= pv10 (- 135300 1))))) (not (=> (and ?v_0 (forall ((?A_59 Int) (?B_60 Int)) (=> (and (>= ?A_59 0) (<= ?A_59 (- pv10 1))) (= (sum 0 (- 5 1) (select (select q ?A_59) ?B_60)) 1.0)))) (and (and ?v_0 (forall ((?C_61 Int) (?D_62 Int)) (let ((?v_3 (select x pv10)) (?v_2 (select sigma ?C_61)) (?v_5 (select sigma ?D_62)) (?v_6 (sqrt (* tptp_pi 2.0)))) (let ((?v_1 (- ?v_3 (select mu ?C_61))) (?v_4 (- ?v_3 (select mu ?D_62)))) (=> (and (>= ?C_61 0) (<= ?C_61 (- 0 1))) (= (select (select q pv10) ?C_61) (divide (divide (* (exp (divide (divide (* ?v_1 ?v_1) tptp_minus_2) (* ?v_2 ?v_2))) (select rho ?C_61)) (* ?v_6 ?v_2)) (sum 0 (- 5 1) (divide (* (exp (divide (divide (* ?v_4 ?v_4) tptp_minus_2) (* ?v_5 ?v_5))) (select rho ?D_62)) (* ?v_6 ?v_5)))))))))) (forall ((?E_63 Int) (?F_64 Int)) (=> (and (>= ?E_63 0) (<= ?E_63 (- pv10 1))) (= (sum 0 (- 5 1) (select (select q ?E_63) ?F_64)) 1.0))))))))
(check-sat)
(exit)
