...
(assert (not (= def use)))
(assert (let ((?v_3 (select x pv10)) (?v_1 (select sigma pv85)) (?v_8 (>= pv10 0)) (?v_9 (>= pv47 0)) (?v_10 (<= pv10 (- 135300 1))) (?v_2 (- 5 1))) (let ((?v_11 (<= pv47 ?v_2)) (?v_5 (select sigma pv45)) (?v_6 (sqrt (* tptp_pi 2.0))) (?v_0 (- ?v_3 (select mu pv85)))) (let ((?v_7 (divide (* (exp (divide (divide (* ?v_0 ?v_0) tptp_minus_2) (* ?v_1 ?v_1))) (select rho pv85)) (* ?v_6 ?v_1))) (?v_4 (- ?v_3 (select mu pv45)))) (not (=> (and (and (and (and (and (and (and (and (= pv84 (sum 0 (- pv45 1) ?v_7)) ?v_8) (>= pv45 0)) ?v_9) ?v_10) (<= pv45 ?v_2)) ?v_11) (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_13 (select sigma ?A_59)) (?v_15 (select sigma ?B_60)) (?v_12 (- ?v_3 (select mu ?A_59))) (?v_14 (- ?v_3 (select mu ?B_60)))) (=> (and (>= ?A_59 0) (<= ?A_59 (- pv47 1))) (= (select (select q pv10) ?A_59) (divide (divide (* (exp (divide (divide (* ?v_12 ?v_12) tptp_minus_2) (* ?v_13 ?v_13))) (select rho ?A_59)) (* ?v_6 ?v_13)) (sum 0 ?v_2 (divide (* (exp (divide (divide (* ?v_14 ?v_14) tptp_minus_2) (* ?v_15 ?v_15))) (select rho ?B_60)) (* ?v_6 ?v_15))))))))) (forall ((?C_61 Int) (?D_62 Int)) (=> (and (>= ?C_61 0) (<= ?C_61 (- pv10 1))) (= (sum 0 ?v_2 (select (select q ?C_61) ?D_62)) 1.0)))) (and (and (and (and (and (and (= (+ pv84 (divide (* (exp (divide (divide (* ?v_4 ?v_4) tptp_minus_2) (* ?v_5 ?v_5))) (select rho pv45)) (* ?v_6 ?v_5))) (sum 0 (- (+ 1 pv45) 1) ?v_7)) ?v_8) ?v_9) ?v_10) ?v_11) (forall ((?E_63 Int) (?F_64 Int)) (let ((?v_17 (select sigma ?E_63)) (?v_19 (select sigma ?F_64)) (?v_16 (- ?v_3 (select mu ?E_63))) (?v_18 (- ?v_3 (select mu ?F_64)))) (=> (and (>= ?E_63 0) (<= ?E_63 (- pv47 1))) (= (select (select q pv10) ?E_63) (divide (divide (* (exp (divide (divide (* ?v_16 ?v_16) tptp_minus_2) (* ?v_17 ?v_17))) (select rho ?E_63)) (* ?v_6 ?v_17)) (sum 0 ?v_2 (divide (* (exp (divide (divide (* ?v_18 ?v_18) tptp_minus_2) (* ?v_19 ?v_19))) (select rho ?F_64)) (* ?v_6 ?v_19))))))))) (forall ((?G_65 Int) (?H_66 Int)) (=> (and (>= ?G_65 0) (<= ?G_65 (- pv10 1))) (= (sum 0 ?v_2 (select (select q ?G_65) ?H_66)) 1.0))))))))))
(check-sat)
(exit)
