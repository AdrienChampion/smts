...
(assert (not (= def use)))
(assert (not (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_2 0.0) (?v_8 (divide 1.0 400.0))) (let ((?v_0 (store q_ds1_filter 0 (store (select q_ds1_filter 0) 0 (* ?v_8 (select sigma 0)))))) (let ((?v_1 (store ?v_0 0 (store (select ?v_0 0) 1 ?v_2)))) (let ((?v_3 (store ?v_1 0 (store (select ?v_1 0) 2 ?v_2)))) (let ((?v_4 (store ?v_3 0 (store (select ?v_3 0) 3 ?v_2)))) (let ((?v_5 (store ?v_4 0 (store (select ?v_4 0) 4 ?v_2)))) (let ((?v_6 (store ?v_5 0 (store (select ?v_5 0) 5 ?v_2)))) (let ((?v_7 (store ?v_6 1 (store (select ?v_6 1) 0 ?v_2)))) (let ((?v_9 (store ?v_7 1 (store (select ?v_7 1) 1 (* ?v_8 (select sigma 1)))))) (let ((?v_10 (store ?v_9 1 (store (select ?v_9 1) 2 ?v_2)))) (let ((?v_11 (store ?v_10 1 (store (select ?v_10 1) 3 ?v_2)))) (let ((?v_12 (store ?v_11 1 (store (select ?v_11 1) 4 ?v_2)))) (let ((?v_13 (store ?v_12 1 (store (select ?v_12 1) 5 ?v_2)))) (let ((?v_14 (store ?v_13 2 (store (select ?v_13 2) 0 ?v_2)))) (let ((?v_15 (store ?v_14 2 (store (select ?v_14 2) 1 ?v_2)))) (let ((?v_16 (store ?v_15 2 (store (select ?v_15 2) 2 (* ?v_8 (select sigma 2)))))) (let ((?v_17 (store ?v_16 2 (store (select ?v_16 2) 3 ?v_2)))) (let ((?v_18 (store ?v_17 2 (store (select ?v_17 2) 4 ?v_2)))) (let ((?v_19 (store ?v_18 2 (store (select ?v_18 2) 5 ?v_2)))) (let ((?v_20 (store ?v_19 3 (store (select ?v_19 3) 0 ?v_2)))) (let ((?v_21 (store ?v_20 3 (store (select ?v_20 3) 1 ?v_2)))) (let ((?v_22 (store ?v_21 3 (store (select ?v_21 3) 2 ?v_2)))) (let ((?v_23 (store ?v_22 3 (store (select ?v_22 3) 3 (* ?v_8 (select sigma 3)))))) (let ((?v_24 (store ?v_23 3 (store (select ?v_23 3) 4 ?v_2)))) (let ((?v_25 (store ?v_24 3 (store (select ?v_24 3) 5 ?v_2)))) (let ((?v_26 (store ?v_25 4 (store (select ?v_25 4) 0 ?v_2)))) (let ((?v_27 (store ?v_26 4 (store (select ?v_26 4) 1 ?v_2)))) (let ((?v_28 (store ?v_27 4 (store (select ?v_27 4) 2 ?v_2)))) (let ((?v_29 (store ?v_28 4 (store (select ?v_28 4) 3 ?v_2)))) (let ((?v_30 (store ?v_29 4 (store (select ?v_29 4) 4 (* ?v_8 (select sigma 4)))))) (let ((?v_31 (store ?v_30 4 (store (select ?v_30 4) 5 ?v_2)))) (let ((?v_32 (store ?v_31 5 (store (select ?v_31 5) 0 ?v_2)))) (let ((?v_33 (store ?v_32 5 (store (select ?v_32 5) 1 ?v_2)))) (let ((?v_34 (store ?v_33 5 (store (select ?v_33 5) 2 ?v_2)))) (let ((?v_35 (store ?v_34 5 (store (select ?v_34 5) 3 ?v_2)))) (let ((?v_36 (store ?v_35 5 (store (select ?v_35 5) 4 ?v_2)))) (let ((?v_37 (store ?v_36 5 (store (select ?v_36 5) 5 (* ?v_8 (select sigma 5)))))) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 5)) (<= ?B_60 5)) (= (select (select ?v_37 ?A_59) ?B_60) (select (select ?v_37 ?B_60) ?A_59)))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
