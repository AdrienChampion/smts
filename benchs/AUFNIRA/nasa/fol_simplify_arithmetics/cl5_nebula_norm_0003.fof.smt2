...
(assert (not (= def use)))
(assert (let ((?v_1 0.0) (?v_0 (select (select q tptp_sum_index) pv35)) (?v_2 (select x tptp_sum_index))) (let ((?v_3 (- ?v_2 (select (store mu pv35 (divide pv80 pv44)) pv35)))) (not (=> (and (and (and (and (not (= ?v_1 pv44)) (= pv78 (sum 0 135299 ?v_0))) (= pv80 (sum 0 135299 (* ?v_0 ?v_2)))) (>= pv35 0)) (<= pv35 4)) (= ?v_1 (sum 0 (- 1) (* ?v_3 (* ?v_3 ?v_0)))))))))
(check-sat)
(exit)
