...
(assert (not (= def use)))
(assert (not (=> (and (and (and (and (and (and (>= pv5 0) (<= pv5 (- 999 1))) (> pv5 0)) (forall ((?A_59 Int) (?B_60 Int)) (let ((?v_0 (- 6 1))) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 ?v_0)) (<= ?B_60 ?v_0)) (= (select (select q_ds1_filter ?A_59) ?B_60) (select (select q_ds1_filter ?B_60) ?A_59)))))) (forall ((?C_61 Int) (?D_62 Int)) (let ((?v_1 (- 3 1))) (=> (and (and (and (>= ?C_61 0) (>= ?D_62 0)) (<= ?C_61 ?v_1)) (<= ?D_62 ?v_1)) (= (select (select r_ds1_filter ?C_61) ?D_62) (select (select r_ds1_filter ?D_62) ?C_61)))))) (forall ((?E_63 Int) (?F_64 Int)) (let ((?v_2 (- 6 1))) (=> (and (and (and (>= ?E_63 0) (>= ?F_64 0)) (<= ?E_63 ?v_2)) (<= ?F_64 ?v_2)) (= (select (select pminus_ds1_filter ?E_63) ?F_64) (select (select pminus_ds1_filter ?F_64) ?E_63)))))) (forall ((?G_65 Int)) (=> (and (>= ?G_65 0) (<= ?G_65 (- 6 1))) (forall ((?H_66 Int)) (=> (and (>= ?H_66 0) (<= ?H_66 (- 6 1))) (= (select (select id_ds1_filter ?G_65) ?H_66) (select (select id_ds1_filter ?H_66) ?G_65))))))) (forall ((?I_67 Int) (?J_68 Int)) (let ((?v_3 (- 6 1)) (?v_15 (select (select xhatmin_ds1_filter 5) 0)) (?v_14 (select (select u 2) pv5)) (?v_12 (select (select u 1) pv5)) (?v_11 (select (select xhatmin_ds1_filter 4) 0)) (?v_8 (select (select xhatmin_ds1_filter 3) 0)) (?v_7 (select (select u 0) pv5)) (?v_16 (trans h_ds1_filter))) (let ((?v_17 (tptp_mmul pminus_ds1_filter (tptp_mmul ?v_16 (inv (tptp_madd r_ds1_filter (tptp_mmul h_ds1_filter (tptp_mmul pminus_ds1_filter ?v_16)))))))) (let ((?v_18 (tptp_msub id_ds1_filter (tptp_mmul ?v_17 h_ds1_filter))) (?v_5 (divide 1.0 400.0))) (let ((?v_4 (store phi_ds1_filter 2 (store (select phi_ds1_filter 2) 1 (* ?v_5 (- ?v_8 ?v_7)))))) (let ((?v_6 (store ?v_4 2 (store (select ?v_4 2) 0 (* ?v_5 (- ?v_12 ?v_11)))))) (let ((?v_9 (store ?v_6 1 (store (select ?v_6 1) 2 (* ?v_5 (- ?v_7 ?v_8)))))) (let ((?v_10 (store ?v_9 1 (store (select ?v_9 1) 0 (* ?v_5 (- ?v_15 ?v_14)))))) (let ((?v_13 (store ?v_10 0 (store (select ?v_10 0) 2 (* ?v_5 (- ?v_11 ?v_12)))))) (let ((?v_19 (store ?v_13 0 (store (select ?v_13 0) 1 (* ?v_5 (- ?v_14 ?v_15)))))) (let ((?v_20 (tptp_madd q_ds1_filter (tptp_mmul ?v_19 (tptp_mmul (tptp_madd (tptp_mmul ?v_17 (tptp_mmul r_ds1_filter (trans ?v_17))) (tptp_mmul ?v_18 (tptp_mmul pminus_ds1_filter (trans ?v_18)))) (trans ?v_19)))))) (=> (and (and (and (>= ?I_67 0) (>= ?J_68 0)) (<= ?I_67 ?v_3)) (<= ?J_68 ?v_3)) (= (select (select ?v_20 ?I_67) ?J_68) (select (select ?v_20 ?J_68) ?I_67)))))))))))))))))
(check-sat)
(exit)
