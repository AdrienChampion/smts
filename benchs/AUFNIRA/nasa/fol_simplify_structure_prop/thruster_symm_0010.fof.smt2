...
(assert (not (= def use)))
(assert (not (=> (and (>= (- 4 1) 0) (>= (- 1000 1) 0)) (forall ((?A_59 Real)) (=> (and (<= 0 7) (>= (- 1000 1) 0)) (forall ((?L_60 Real)) (let ((?v_0 (> pv5 0))) (=> (and (and (and (and (and (and (and (not ?v_0) (>= pv5 0)) (<= pv5 588)) ?v_0) (forall ((?B_61 Int) (?C_62 Int)) (let ((?v_1 (- 6 1))) (=> (and (and (and (>= ?B_61 0) (>= ?C_62 0)) (<= ?B_61 ?v_1)) (<= ?C_62 ?v_1)) (= (select (select q_thruster_filter ?B_61) ?C_62) (select (select q_thruster_filter ?C_62) ?B_61)))))) (forall ((?D_63 Int) (?E_64 Int)) (let ((?v_2 (- 4 1))) (=> (and (and (and (>= ?D_63 0) (>= ?E_64 0)) (<= ?D_63 ?v_2)) (<= ?E_64 ?v_2)) (= (select (select r_thruster_filter ?D_63) ?E_64) (select (select r_thruster_filter ?E_64) ?D_63)))))) (forall ((?F_65 Int) (?G_66 Int)) (let ((?v_3 (- 6 1))) (=> (and (and (and (>= ?F_65 0) (>= ?G_66 0)) (<= ?F_65 ?v_3)) (<= ?G_66 ?v_3)) (= (select (select pminus_thruster_filter ?F_65) ?G_66) (select (select pminus_thruster_filter ?G_66) ?F_65)))))) (forall ((?H_67 Int)) (=> (and (>= ?H_67 0) (<= ?H_67 (- 6 1))) (forall ((?I_68 Int)) (=> (and (>= ?I_68 0) (<= ?I_68 (- 6 1))) (= (select (select id_thruster_filter ?H_67) ?I_68) (select (select id_thruster_filter ?I_68) ?H_67))))))) (forall ((?J_69 Int) (?K_70 Int)) (let ((?v_4 (- 6 1)) (?v_6 (select (select xhatmin_thruster_filter 0) 0))) (let ((?v_7 (sin ?v_6)) (?v_16 (select (select tr 4) pv5)) (?v_15 (select (select tr 3) pv5)) (?v_5 (cos ?v_6)) (?v_14 (select (select tr 6) pv5)) (?v_13 (select (select tr 5) pv5)) (?v_9 (select (select tr 1) pv5)) (?v_10 (select (select tr 2) pv5)) (?v_11 (select (select tr 0) pv5)) (?v_12 (select (select tr 7) pv5))) (let ((?v_18 (- (- (- (- (+ (* ?v_5 ?v_15) (+ (* ?v_5 ?v_16) (+ (* ?v_7 ?v_9) (* ?v_7 ?v_10)))) (* ?v_5 ?v_11)) (* ?v_5 ?v_12)) (* ?v_7 ?v_13)) (* ?v_7 ?v_14)))) (let ((?v_8 (store phi_thruster_filter 5 (store (select phi_thruster_filter 5) 0 (divide (* tptp_float_0_034 (* tptp_float_1_2 ?v_18)) tptp_float_70_707)))) (?v_20 (- (- (- (- (+ (* ?v_5 ?v_9) (+ (* ?v_5 ?v_10) (+ (* ?v_7 ?v_11) (* ?v_7 ?v_12)))) (* ?v_5 ?v_13)) (* ?v_5 ?v_14)) (* ?v_7 ?v_15)) (* ?v_7 ?v_16)))) (let ((?v_17 (store ?v_8 4 (store (select ?v_8 4) 0 (divide (* tptp_float_0_034 (* tptp_float_1_2 ?v_20)) tptp_float_70_707)))) (?v_24 (+ (* tptp_float_0_217 ?v_7) (* tptp_float_0_423 ?v_5)))) (let ((?v_22 (store h_thruster_filter 3 (store (select h_thruster_filter 3) 0 (- ?v_24)))) (?v_26 (* tptp_float_0_217 ?v_5)) (?v_27 (* tptp_float_0_423 ?v_7))) (let ((?v_23 (store ?v_22 2 (store (select ?v_22 2) 0 (- ?v_27 ?v_26))))) (let ((?v_25 (store ?v_23 1 (store (select ?v_23 1) 0 ?v_24)))) (let ((?v_31 (store ?v_25 0 (store (select ?v_25 0) 0 (- ?v_26 ?v_27))))) (let ((?v_32 (trans ?v_31)) (?v_28 (store r_thruster_filter 3 (store (select r_thruster_filter 3) 3 (select (select rho 3) pv5))))) (let ((?v_29 (store ?v_28 2 (store (select ?v_28 2) 2 (select (select rho 2) pv5))))) (let ((?v_30 (store ?v_29 1 (store (select ?v_29 1) 1 (select (select rho 1) pv5))))) (let ((?v_33 (store ?v_30 0 (store (select ?v_30 0) 0 (select (select rho 0) pv5))))) (let ((?v_34 (tptp_mmul pminus_thruster_filter (tptp_mmul ?v_32 (inv (tptp_madd ?v_33 (tptp_mmul ?v_31 (tptp_mmul pminus_thruster_filter ?v_32)))))))) (let ((?v_35 (tptp_msub id_thruster_filter (tptp_mmul ?v_34 ?v_31))) (?v_21 (divide (* tptp_float_0_034 tptp_float_0_034) 2.0))) (let ((?v_19 (store ?v_17 2 (store (select ?v_17 2) 0 (divide (* tptp_float_1_2 (* ?v_18 ?v_21)) tptp_float_70_707))))) (let ((?v_36 (store ?v_19 1 (store (select ?v_19 1) 0 (divide (* tptp_float_1_2 (* ?v_20 ?v_21)) tptp_float_70_707))))) (let ((?v_37 (tptp_madd q_thruster_filter (tptp_mmul ?v_36 (tptp_mmul (tptp_madd (tptp_mmul ?v_34 (tptp_mmul ?v_33 (trans ?v_34))) (tptp_mmul ?v_35 (tptp_mmul pminus_thruster_filter (trans ?v_35)))) (trans ?v_36)))))) (=> (and (and (and (>= ?J_69 0) (>= ?K_70 0)) (<= ?J_69 ?v_4)) (<= ?K_70 ?v_4)) (= (select (select ?v_37 ?J_69) ?K_70) (select (select ?v_37 ?K_70) ?J_69))))))))))))))))))))))))))))))
(check-sat)
(exit)
