...
(assert (not (= def use)))
(assert (let ((?v_1 (select sigma tptp_sum_index)) (?v_2 (- 5 1)) (?v_0 (- (select x pv10) (select mu tptp_sum_index)))) (not (=> (and (and (and (and (and (and (= pv84 (sum 0 ?v_2 (divide (* (exp (divide (divide (* ?v_0 ?v_0) tptp_minus_2) (* ?v_1 ?v_1))) (select rho tptp_sum_index)) (* (sqrt (* 2.0 tptp_pi)) ?v_1)))) (>= pv10 0)) (>= pv47 0)) (<= pv10 (- 135300 1))) (<= pv47 ?v_2)) (forall ((?A_59 Int)) (let ((?v_5 (select x pv10)) (?v_6 (sqrt (* 2.0 tptp_pi))) (?v_4 (select sigma ?A_59))) (let ((?v_3 (- ?v_5 (select mu ?A_59)))) (=> (and (>= ?A_59 0) (<= ?A_59 (- pv47 1))) (= (select (select q pv10) ?A_59) (divide (divide (* (exp (divide (divide (* ?v_3 ?v_3) tptp_minus_2) (* ?v_4 ?v_4))) (select rho ?A_59)) (* ?v_6 ?v_4)) (sum 0 ?v_2 (divide (* (exp (divide (divide (* ?v_0 ?v_0) tptp_minus_2) (* ?v_1 ?v_1))) (select rho tptp_sum_index)) (* ?v_6 ?v_1)))))))))) (forall ((?B_60 Int)) (=> (and (>= ?B_60 0) (<= ?B_60 (- pv10 1))) (= (sum 0 ?v_2 (select (select q ?B_60) tptp_sum_index)) 1.0)))) (forall ((?C_61 Int)) (let ((?v_9 (select x pv10)) (?v_12 (sqrt (* 2.0 tptp_pi))) (?v_8 (select sigma pv47)) (?v_11 (select sigma ?C_61))) (let ((?v_7 (- ?v_9 (select mu pv47))) (?v_10 (- ?v_9 (select mu ?C_61)))) (=> (and (>= ?C_61 0) (<= ?C_61 (- (+ 1 pv47) 1))) (= (select (select (store q pv10 (store (select q pv10) pv47 (divide (divide (* (exp (divide (divide (* ?v_7 ?v_7) tptp_minus_2) (* ?v_8 ?v_8))) (select rho pv47)) (* ?v_12 ?v_8)) pv84))) pv10) ?C_61) (divide (divide (* (exp (divide (divide (* ?v_10 ?v_10) tptp_minus_2) (* ?v_11 ?v_11))) (select rho ?C_61)) (* ?v_12 ?v_11)) (sum 0 ?v_2 (divide (* (exp (divide (divide (* ?v_0 ?v_0) tptp_minus_2) (* ?v_1 ?v_1))) (select rho tptp_sum_index)) (* ?v_12 ?v_1)))))))))))))
(check-sat)
(exit)
